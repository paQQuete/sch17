...
window.scwDisableJsAJAX = !0, jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    def: "easeOutQuad", swing: function (e, t, i, n, a) {
        ...
        if (r || (r = .3 * a), o < Math.abs(n)) {
            o = n;
            s = r / 4
        } else s = r / (2 * Math.PI) * Math.asin(n / o);
        ...
        return t < 1 ? o * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * a - s) * (2 * Math.PI) / r) * -.5 + i : o * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * a - s) * (2 * Math.PI) / r) * .5 + n + i
    ...
    var r = {
        TRANSITION_END: "bsTransitionEnd", getUID: function (e) {
            ...
            var t = i.default(e).css("transition-duration"), n = i.default(e).css("transition-delay"),
                a = parseFloat(t), s = parseFloat(n);
            return a || s ? (t = t.split(",")[0], n = n.split(",")[0], 1e3 * (parseFloat(t) + parseFloat(n))) : 0
        }, reflow: function (e) {
            ...
            for (var n in i) if (Object.prototype.hasOwnProperty.call(i, n)) {
                var a = i[n], s = t[n],
                    o = s && r.isElement(s) ? "element" : null === (l = s) || void 0 === l ? "" + l : {}.toString.call(l).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    r.jQueryDetection(), i.default.fn.emulateTransitionEnd = function (e) {
        var t = this, n = !1;
    ...
    var o = "alert", l = i.default.fn[o], d = function () {
        ...
        return t.close = function (e) {
            ...
            var t = r.getSelectorFromElement(e), n = !1;
            ...
            if (i.default(e).removeClass("show"), i.default(e).hasClass("fade")) {
                var n = r.getTransitionDurationFromElement(e);
                i.default(e).one(r.TRANSITION_END, (function (i) {
    ...
    var c = i.default.fn.button, u = function () {
        ...
        return t.toggle = function () {
            ...
            if (n) {
                ...
                if (a) {
                    if ("radio" === a.type) if (a.checked && this._element.classList.contains("active")) e = !1; else {
                        ...
                        s && i.default(s).removeClass("active")
                    }
            ...
            return this.each((function () {
                var a = i.default(this), s = a.data("bs.button");
                s || (s = new e(this), a.data("bs.button", s)), s.shouldAvoidTriggerChange = n, "toggle" === t && s[t]()
            }))
        }, a(e, null, [{
            key: "VERSION", get: function () {
                return "4.5.3"
    ...
    var h = "carousel", p = i.default.fn[h],
        f = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, m = {
            ...
            return t.next = function () {
                ...
                e || (this._isPaused = !0), this._element.querySelector(".carousel-item-next, .carousel-item-prev") && (r.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, t.cycle = function (e) {
                ...
                return e = s({}, f, e), r.typeCheckConfig(h, e, m), e
                ...
                var i = "next" === e, n = "prev" === e, a = this._getItemIndex(t), s = this._items.length - 1;
                if ((n && 0 === a || i && a === s) && !this._config.wrap) return t;
                var r = (a + ("prev" === e ? -1 : 1)) % this._items.length;
                return -1 === r ? this._items[this._items.length - 1] : this._items[r]
            }, t._triggerSlideEvent = function (e, t) {
                var n = this._getItemIndex(e), a = this._getItemIndex(this._element.querySelector(".active.carousel-item")),
                    s = i.default.Event("slide.bs.carousel", {relatedTarget: e, direction: t, from: a, to: n});
                ...
                var n, a, s, o = this, l = this._element.querySelector(".active.carousel-item"), d = this._getItemIndex(l),
                    c = t || l && this._getItemByDirection(e, l), u = this._getItemIndex(c), h = Boolean(this._interval);
                if ("next" === e ? (n = "carousel-item-left", a = "carousel-item-next", s = "left") : (n = "carousel-item-right", a = "carousel-item-prev", s = "right"), c && i.default(c).hasClass("active")) this._isSliding = !1; else if (!this._triggerSlideEvent(c, s).isDefaultPrevented() && l && c) {
                    this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(c);
                    var p = i.default.Event("slid.bs.carousel", {relatedTarget: c, direction: s, from: d, to: u});
                    if (i.default(this._element).hasClass("slide")) {
                        i.default(c).addClass(a), r.reflow(c), i.default(l).addClass(n), i.default(c).addClass(n);
                        ...
                        i.default(l).one(r.TRANSITION_END, (function () {
                ...
                return this.each((function () {
                    var n = i.default(this).data("bs.carousel"), a = s({}, f, i.default(this).data());
                    "object" == typeof t && (a = s({}, a, t));
                    var r = "string" == typeof t ? t : a.slide;
                    if (n || (n = new e(this, a), i.default(this).data("bs.carousel", n)), "number" == typeof t) n.to(t); else if ("string" == typeof r) {
                ...
                if (n) {
                    ...
                    if (a && i.default(a).hasClass("carousel")) {
                        var o = s({}, i.default(a).data(), i.default(this).data()), l = this.getAttribute("data-slide-to");
        ...
        T = {toggle: "boolean", parent: "(string|element)"}, _ = function () {
            function e(e, t) {
                ...
                for (var i = [].slice.call(document.querySelectorAll('[data-toggle="collapse"]')), n = 0, a = i.length; n < a; n++) {
                    var s = i[n], o = r.getSelectorFromElement(s),
                        l = [].slice.call(document.querySelectorAll(o)).filter((function (t) {
                            return t === e
                        }));
                    null !== o && l.length > 0 && (this._selector = o, this._triggerArray.push(s))
                }
            ...
            return t.toggle = function () {
                ...
                if (!(this._isTransitioning || i.default(this._element).hasClass("show") || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter((function (e) {
                    ...
                    var s = i.default.Event("show.bs.collapse");
                ...
                if (!this._isTransitioning && i.default(this._element).hasClass("show")) {
                    ...
                    if (i.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                        ...
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", r.reflow(this._element), i.default(this._element).addClass("collapsing").removeClass("collapse show");
                        var a = this._triggerArray.length;
                        if (a > 0) for (var s = 0; s < a; s++) {
                            var o = this._triggerArray[s], l = r.getSelectorFromElement(o);
                        ...
                        var d = r.getTransitionDurationFromElement(this._element);
                        i.default(this._element).one(r.TRANSITION_END, (function () {
                ...
                return (e = s({}, w, e)).toggle = Boolean(e.toggle), r.typeCheckConfig(y, e, T), e
                ...
                return this.each((function () {
                    var n = i.default(this), a = n.data("bs.collapse"),
                        r = s({}, w, n.data(), "object" == typeof t && t ? t : {});
                    if (!a && r.toggle && "string" == typeof t && /show|hide/.test(t) && (r.toggle = !1), a || (a = new e(this, r), n.data("bs.collapse", a)), "string" == typeof t) {
    ...
    i.default(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', (function (e) {
        ...
        var t = i.default(this), n = r.getSelectorFromElement(this), a = [].slice.call(document.querySelectorAll(n));
    ...
    function z(e) {
        ...
        for (var t = j(10) ? document.body : null, i = e.offsetParent || null; i === t && e.nextElementSibling;) i = (e = e.nextElementSibling).offsetParent;
        var n = i && i.nodeName;
    ...
    function A(e, t) {
        ...
        if (e !== l && t !== l || n.contains(a)) return "BODY" === (o = (r = l).nodeName) || "HTML" !== o && z(r.firstElementChild) !== r ? z(l) : l;
        var d = Y(e);
        return d.host ? A(d.host, t) : A(e, Y(t).host)
    }
    ...
    function B(e, t, i, n) {
        return Math.max(t["offset" + e], t["scroll" + e], i["client" + e], i["offset" + e], i["scroll" + e], j(10) ? parseInt(i["offset" + e]) + parseInt(n["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
    }

    function Q(e) {
        var t = e.body, i = e.documentElement, n = j(10) && getComputedStyle(i);
    ...
    function V(e) {
        ...
        var a = {left: t.left, top: t.top, width: t.right - t.left, height: t.bottom - t.top},
            s = "HTML" === e.nodeName ? Q(e.ownerDocument) : {}, r = s.width || e.clientWidth || a.width,
            o = s.height || e.clientHeight || a.height, l = e.offsetWidth - r, d = e.offsetHeight - o;
        if (l || d) {
            var c = P(e);
            l -= $(c, "x"), d -= $(c, "y"), a.width -= l, a.height -= d
        }
        return W(a)
    }

    function U(e, t) {
        var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = j(10), a = "HTML" === t.nodeName,
            s = V(e), r = V(t), o = I(e), l = P(t), d = parseFloat(l.borderTopWidth), c = parseFloat(l.borderLeftWidth);
        i && a && (r.top = Math.max(r.top, 0), r.left = Math.max(r.left, 0));
        var u = W({top: s.top - r.top - d, left: s.left - r.left - c, width: s.width, height: s.height});
        ...
        return (n && !i ? t.contains(o) : t === o && "BODY" !== o.nodeName) && (u = N(u, t)), u
    }

    function G(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = e.ownerDocument.documentElement,
            n = U(e, i), a = Math.max(i.clientWidth, window.innerWidth || 0),
            s = Math.max(i.clientHeight, window.innerHeight || 0), r = t ? 0 : D(i), o = t ? 0 : D(i, "left"),
            l = {top: r - n.top + n.marginTop, left: o - n.left + n.marginLeft, width: a, height: s};
        return W(l)
    }
    ...
    function Z(e, t, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], s = {top: 0, left: 0},
            r = a ? K(e) : A(e, M(t));
        if ("viewport" === n) s = G(r, a); else {
            var o = void 0;
            "scrollParent" === n ? "BODY" === (o = I(k(t))).nodeName && (o = e.ownerDocument.documentElement) : o = "window" === n ? e.ownerDocument.documentElement : n;
            var l = U(o, r, a);
            if ("HTML" !== o.nodeName || X(r)) s = l; else {
                var d = Q(e.ownerDocument), c = d.height, u = d.width;
                s.top += l.top - l.marginTop, s.bottom = c + l.top, s.left += l.left - l.marginLeft, s.right = u + l.left
            }
        }
    ...
    function te(e, t, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null, a = n ? K(t) : A(t, M(i));
        return U(i, a, n)
    }
    ...
    function ae(e, t, i) {
        i = i.split("-")[0];
        var n = ie(e), a = {width: n.width, height: n.height}, s = -1 !== ["right", "left"].indexOf(i),
            r = s ? "top" : "left", o = s ? "left" : "top", l = s ? "height" : "width", d = s ? "width" : "height";
        return a[r] = t[r] + t[l] / 2 - n[l] / 2, a[o] = i === o ? t[o] - n[d] : t[ne(o)], a
    }
    ...
    function re(e, t, i) {
        return (void 0 === i ? e : e.slice(0, function (e, t, i) {
            ...
            e.enabled && E(i) && (t.offsets.popper = W(t.offsets.popper), t.offsets.reference = W(t.offsets.reference), t = i(t, e))
        })), t
    }
    ...
    function oe() {
        if (!this.state.isDestroyed) {
            ...
            e.offsets.reference = te(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = ee(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = ae(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = re(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
        }
    }
    ...
    function he() {
        this.state.eventsEnabled || (this.state = function (e, t, i, n) {
            ...
            return function e(t, i, n, a) {
                ...
                r.addEventListener(i, n, {passive: !0}), s || e(I(r.parentNode), i, n, a), a.push(r)
    ...
    function me(e, t) {
        Object.keys(t).forEach((function (i) {
            var n = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(i) && fe(t[i]) && (n = "px"), e.style[i] = t[i] + n
        }))
    }
    ...
    function we(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = be.indexOf(e),
    ...
    var Te = {
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (e) {
                    ...
                    if (n) {
                        var a = e.offsets, s = a.reference, r = a.popper, o = -1 !== ["bottom", "top"].indexOf(i),
                            l = o ? "left" : "top", d = o ? "width" : "height",
                            c = {start: H({}, l, s[l]), end: H({}, l, s[l] + s[d] - r[d])};
                        e.offsets.popper = q({}, r, c[n])
                    }
                    return e
                }
            }, offset: {
                order: 200, enabled: !0, fn: function (e, t) {
                    var i, n = t.offset, a = e.placement, s = e.offsets, r = s.popper, o = s.reference,
                        l = a.split("-")[0];
                    return i = fe(+n) ? [+n, 0] : function (e, t, i, n) {
                        var a = [0, 0], s = -1 !== ["right", "left"].indexOf(n),
                            r = e.split(/(\+|\-)/).map((function (e) {
                                return e.trim()
                            })), o = r.indexOf(se(r, (function (e) {
                                return -1 !== e.search(/,|\s/)
                            })));
                        ...
                        return (d = d.map((function (e, n) {
                            var a = (1 === n ? !s : s) ? "height" : "width", r = !1;
                            return e.reduce((function (e, t) {
                                return "" === e[e.length - 1] && -1 !== ["+", "-"].indexOf(t) ? (e[e.length - 1] = t, r = !0, e) : r ? (e[e.length - 1] += t, r = !1, e) : e.concat(t)
                            }), []).map((function (e) {
                                return function (e, t, i, n) {
                                    var a = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), s = +a[1], r = a[2];
                                    if (!s) return e;
                                    if (0 === r.indexOf("%")) {
                                        var o = void 0;
                                        switch (r) {
                    ...
                    }(n, r, o, l), "left" === l ? (r.top += i[0], r.left -= i[1]) : "right" === l ? (r.top += i[0], r.left += i[1]) : "top" === l ? (r.left += i[0], r.top -= i[1]) : "bottom" === l && (r.left += i[0], r.top += i[1]), e.popper = r, e
                }, offset: 0
            }, preventOverflow: {
                order: 300, enabled: !0, fn: function (e, t) {
                    var i = t.boundariesElement || z(e.instance.popper);
                    e.instance.reference === i && (i = z(i));
                    var n = de("transform"), a = e.instance.popper.style, s = a.top, r = a.left, o = a[n];
                    a.top = "", a.left = "", a[n] = "";
                    var l = Z(e.instance.popper, e.instance.reference, t.padding, i, e.positionFixed);
                    a.top = s, a.left = r, a[n] = o, t.boundaries = l;
                    var d = t.priority, c = e.offsets.popper, u = {
                        primary: function (e) {
                            var i = c[e];
                            return c[e] < l[e] && !t.escapeWithReference && (i = Math.max(c[e], l[e])), H({}, e, i)
                        }, secondary: function (e) {
                            var i = "right" === e ? "left" : "top", n = c[i];
                            return c[e] > l[e] && !t.escapeWithReference && (n = Math.min(c[i], l[e] - ("right" === e ? c.width : c.height))), H({}, i, n)
                        }
                    };
                ...
                order: 400, enabled: !0, fn: function (e) {
                    var t = e.offsets, i = t.popper, n = t.reference, a = e.placement.split("-")[0], s = Math.floor,
                        r = -1 !== ["top", "bottom"].indexOf(a), o = r ? "right" : "bottom", l = r ? "left" : "top",
                        d = r ? "width" : "height";
                ...
                order: 500, enabled: !0, fn: function (e, t) {
                    ...
                    var a = e.placement.split("-")[0], s = e.offsets, r = s.popper, o = s.reference,
                        l = -1 !== ["left", "right"].indexOf(a), d = l ? "height" : "width", c = l ? "Top" : "Left",
                        u = c.toLowerCase(), h = l ? "left" : "top", p = l ? "bottom" : "right", f = ie(n)[d];
                    o[p] - f < r[u] && (e.offsets.popper[u] -= r[u] - (o[p] - f)), o[u] + f > r[p] && (e.offsets.popper[u] += o[u] + f - r[p]), e.offsets.popper = W(e.offsets.popper);
                    ...
                    return b = Math.max(Math.min(r[d] - f, b), 0), e.arrowElement = n, e.offsets.arrow = (H(i = {}, u, Math.round(b)), H(i, h, ""), i), e
                }, element: "[x-arrow]"
            }, flip: {
                order: 600,
                enabled: !0,
                fn: function (e, t) {
                    ...
                    var i = Z(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
                        n = e.placement.split("-")[0], a = ne(n), s = e.placement.split("-")[1] || "", r = [];
                    switch (t.behavior) {
                        case"flip":
                            r = [n, a];
                            break;
                    ...
                    return r.forEach((function (o, l) {
                        ...
                        var d = e.offsets.popper, c = e.offsets.reference, u = Math.floor,
                            ...
                            w = !!t.flipVariationsByContent && (y && "start" === s && f || y && "end" === s && p || !y && "start" === s && g || !y && "end" === s && m),
                            T = b || w;
                        (h || v || T) && (e.flipped = !0, (h || v) && (n = r[l + 1]), T && (s = function (e) {
                            return "end" === e ? "start" : "start" === e ? "end" : e
                        }(s)), e.placement = n + (s ? "-" + s : ""), e.offsets.popper = q({}, e.offsets.popper, ae(e.instance.popper, e.offsets.reference, e.placement)), e = re(e.instance.modifiers, e, "flip"))
                    })), e
                },
                behavior: "flip",
                padding: 5,
                ...
                order: 700, enabled: !1, fn: function (e) {
                    var t = e.placement, i = t.split("-")[0], n = e.offsets, a = n.popper, s = n.reference,
                        r = -1 !== ["left", "right"].indexOf(i), o = -1 === ["top", "left"].indexOf(i);
                    return a[r ? "left" : "top"] = s[i] - (o ? a[r ? "width" : "height"] : 0), e.placement = ne(t), e.offsets.popper = W(a), e
                }
            }, hide: {
                order: 800, enabled: !0, fn: function (e) {
                    if (!ve(e.instance.modifiers, "hide", "preventOverflow")) return e;
                    var t = e.offsets.reference, i = se(e.instance.modifiers, (function (e) {
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var i = t.x, n = t.y, a = e.offsets.popper, s = se(e.instance.modifiers, (function (e) {
                        return "applyStyle" === e.name
                    })).gpuAcceleration;
                    void 0 !== s && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var r, o, l = void 0 !== s ? s : t.gpuAcceleration, d = z(e.instance.popper), c = V(d),
                        u = {position: a.position}, h = function (e, t) {
                            var i = e.offsets, n = i.popper, a = i.reference, s = Math.round, r = Math.floor,
                                o = function (e) {
                                    return e
                                }, l = s(a.width), d = s(n.width), c = -1 !== ["left", "right"].indexOf(e.placement),
                                u = -1 !== e.placement.indexOf("-"), h = t ? c || u || l % 2 == d % 2 ? s : r : o,
                                p = t ? s : o;
                            return {
                        ...
                        }(e, window.devicePixelRatio < 2 || !ge), p = "bottom" === i ? "top" : "bottom",
                        f = "right" === n ? "left" : "right", m = de("transform");
                    if (o = "bottom" === p ? "HTML" === d.nodeName ? -d.clientHeight + h.bottom : -c.height + h.bottom : h.top, r = "right" === f ? "HTML" === d.nodeName ? -d.clientWidth + h.right : -c.width + h.right : h.left, l && m) u[m] = "translate3d(" + r + "px, " + o + "px, 0)", u[p] = 0, u[f] = 0, u.willChange = "transform"; else {
                        var g = "bottom" === p ? -1 : 1, v = "right" === f ? -1 : 1;
                        u[p] = o * g, u[f] = r * v, u.willChange = p + ", " + f
                    }
                    var y = {"x-placement": e.placement};
                    return e.attributes = q({}, y, e.attributes), e.styles = q({}, u, e.styles), e.arrowStyles = q({}, e.offsets.arrow, e.arrowStyles), e
                ...
                order: 900, enabled: !0, fn: function (e) {
                    ...
                    var s = te(a, t, e, i.positionFixed),
                        r = ee(i.placement, s, t, e, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
                    return t.setAttribute("x-placement", r), me(t, {position: i.positionFixed ? "fixed" : "absolute"}), i
        ...
        function e(t, i) {
            ...
            }, this.update = S(this.update.bind(this)), this.options = q({}, e.Defaults, a), this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
            }, this.reference = t && t.jquery ? t[0] : t, this.popper = i && i.jquery ? i[0] : i, this.options.modifiers = {}, Object.keys(q({}, e.Defaults.modifiers, a.modifiers)).forEach((function (t) {
                n.options.modifiers[t] = q({}, e.Defaults.modifiers[t] || {}, a.modifiers ? a.modifiers[t] : {})
    ...
    _e.Utils = ("undefined" != typeof window ? window : global).PopperUtils, _e.placements = ye, _e.Defaults = Te;
    var Ce = "dropdown", xe = i.default.fn[Ce], Se = new RegExp("38|40|27"), Ee = {
        offset: 0,
        flip: !0,
        ...
        return t.toggle = function () {
            ...
            if (void 0 === t && (t = !1), !(this._element.disabled || i.default(this._element).hasClass("disabled") || i.default(this._menu).hasClass("show"))) {
                ...
                if (i.default(s).trigger(a), !a.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        if (void 0 === _e) throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org/)");
                        var o = this._element;
                        "parent" === this._config.reference ? o = s : r.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && i.default(s).addClass("position-static"), this._popper = new _e(o, this._menu, this._getPopperConfig())
                    }
                    "ontouchstart" in document.documentElement && 0 === i.default(s).closest(".navbar-nav").length && i.default(document.body).children().on("mouseover", null, i.default.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), i.default(this._menu).toggleClass("show"), i.default(s).toggleClass("show").trigger(i.default.Event("shown.bs.dropdown", n))
                }
            }
        }, t.hide = function () {
            ...
            return e = s({}, this.constructor.Default, i.default(this._element).data(), e), r.typeCheckConfig(Ce, e, this.constructor.DefaultType), e
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var n = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), a = 0, s = n.length; a < s; a++) {
                var r = e._getParentFromElement(n[a]), o = i.default(n[a]).data("bs.dropdown"),
                    l = {relatedTarget: n[a]};
                if (t && "click" === t.type && (l.clickEvent = t), o) {
                    ...
                    if (i.default(r).hasClass("show") && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && i.default.contains(r, t.target))) {
                        ...
                        i.default(r).trigger(c), c.isDefaultPrevented() || ("ontouchstart" in document.documentElement && i.default(document.body).children().off("mouseover", null, i.default.noop), n[a].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), i.default(d).removeClass("show"), i.default(r).removeClass("show").trigger(i.default.Event("hidden.bs.dropdown", l)))
                    }
                }
            }
        }, e._getParentFromElement = function (e) {
            var t, i = r.getSelectorFromElement(e);
    ...
    i.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', ke._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", ke._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", ke._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function (e) {
        e.preventDefault(), e.stopPropagation(), ke._jQueryInterface.call(i.default(this), "toggle")
    })).on("click.bs.dropdown.data-api", ".dropdown form", (function (e) {
        e.stopPropagation()
    })), i.default.fn[Ce] = ke._jQueryInterface, i.default.fn[Ce].Constructor = ke, i.default.fn[Ce].noConflict = function () {
        return i.default.fn[Ce] = xe, ke._jQueryInterface
    };
    var Ie = i.default.fn.modal, Me = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        Oe = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, Le = function () {
            function e(e, t) {
            ...
            return t.toggle = function (e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (i.default(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (a && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), i.default(document).off("focusin.bs.modal"), i.default(this._element).removeClass("show"), i.default(this._element).off("click.dismiss.bs.modal"), i.default(this._dialog).off("mousedown.dismiss.bs.modal"), a) {
                            ...
                            i.default(this._element).one(r.TRANSITION_END, (function (e) {
                ...
                return e = s({}, Me, e), r.typeCheckConfig("modal", e, Oe), e
                ...
                if ("static" === this._config.backdrop) {
                    ...
                    i.default(this._element).off(r.TRANSITION_END), i.default(this._element).one(r.TRANSITION_END, (function () {
                        e._element.classList.remove("modal-static"), n || i.default(e._element).one(r.TRANSITION_END, (function () {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), i.default(this._dialog).hasClass("modal-dialog-scrollable") && a ? a.scrollTop = 0 : this._element.scrollTop = 0, n && r.reflow(this._element), i.default(this._element).addClass("show"), this._config.focus && this._enforceFocus();
                var s = i.default.Event("shown.bs.modal", {relatedTarget: e}), o = function () {
                ...
                if (n) {
                    ...
                    i.default(this._dialog).one(r.TRANSITION_END, o).emulateTransitionEnd(l)
                } else o()
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    })), n && r.reflow(this._backdrop), i.default(this._backdrop).addClass("show"), !e) return;
                    if (!n) return void e();
                    var a = r.getTransitionDurationFromElement(this._backdrop);
                    i.default(this._backdrop).one(r.TRANSITION_END, e).emulateTransitionEnd(a)
                    ...
                    if (i.default(this._element).hasClass("fade")) {
                        ...
                        i.default(this._backdrop).one(r.TRANSITION_END, s).emulateTransitionEnd(o)
                    } else s()
                } else e && e()
                ...
                if (this._isBodyOverflowing) {
                    ...
                    i.default(t).each((function (t, n) {
                        var a = n.style.paddingRight, s = i.default(n).css("padding-right");
                        i.default(n).data("padding-right", a).css("padding-right", parseFloat(s) + e._scrollbarWidth + "px")
                    })), i.default(n).each((function (t, n) {
                        var a = n.style.marginRight, s = i.default(n).css("margin-right");
                        i.default(n).data("margin-right", a).css("margin-right", parseFloat(s) - e._scrollbarWidth + "px")
                    }));
                    var a = document.body.style.paddingRight, s = i.default(document.body).css("padding-right");
                    i.default(document.body).data("padding-right", a).css("padding-right", parseFloat(s) + this._scrollbarWidth + "px")
                }
                ...
                return this.each((function () {
                    var a = i.default(this).data("bs.modal"),
                        r = s({}, Me, i.default(this).data(), "object" == typeof t && t ? t : {});
                    if (a || (a = new e(this, r), i.default(this).data("bs.modal", a)), "string" == typeof t) {
                        if (void 0 === a[t]) throw new TypeError('No method named "' + t + '"');
                        a[t](n)
    ...
    i.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', (function (e) {
        var t, n = this, a = r.getSelectorFromElement(this);
    ...
    function Ae(e, t, i) {
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(t), s = [].slice.call(n.body.querySelectorAll("*")), r = function (e, i) {
            var n = s[e], r = n.nodeName.toLowerCase();
            if (-1 === a.indexOf(n.nodeName.toLowerCase())) return n.parentNode.removeChild(n), "continue";
            var o = [].slice.call(n.attributes), l = [].concat(t["*"] || [], t[r] || []);
            o.forEach((function (e) {
                (function (e, t) {
                    var i = e.nodeName.toLowerCase();
                    if (-1 !== t.indexOf(i)) return -1 === je.indexOf(i) || Boolean(e.nodeValue.match(ze) || e.nodeValue.match(Ye));
                    for (var n = t.filter((function (e) {
                        return e instanceof RegExp
                    })), a = 0, s = n.length; a < s; a++) if (i.match(n[a])) return !0;
                    return !1
                })(e, l) || n.removeAttribute(e.nodeName)
            }))
        }, o = 0, l = s.length; o < l; o++) r(o);
        return n.body.innerHTML
    }

    var De = "tooltip", Ne = i.default.fn[De], $e = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        Be = ["sanitize", "whiteList", "sanitizeFn"], Qe = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object",
            popperConfig: "(null|object)"
        }, Re = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, Fe = {
            animation: !0,
            ...
            return t.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var s = this.getTipElement(), o = r.getUID(this.constructor.NAME);
                    s.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && i.default(s).addClass("fade");
                    var l = "function" == typeof this.config.placement ? this.config.placement.call(this, s, this.element) : this.config.placement,
                        d = this._getAttachment(l);
                    this.addAttachmentClass(d);
                    var c = this._getContainer();
                    i.default(s).data(this.constructor.DATA_KEY, this), i.default.contains(this.element.ownerDocument.documentElement, this.tip) || i.default(s).appendTo(c), i.default(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new _e(this.element, s, this._getPopperConfig(d)), i.default(s).addClass("show"), "ontouchstart" in document.documentElement && i.default(document.body).children().on("mouseover", null, i.default.noop);
                    var u = function () {
                    ...
                    if (i.default(this.tip).hasClass("fade")) {
                        var h = r.getTransitionDurationFromElement(this.tip);
                        i.default(this.tip).one(r.TRANSITION_END, u).emulateTransitionEnd(h)
                    } else u()
                }
            }, t.hide = function (e) {
                var t = this, n = this.getTipElement(), a = i.default.Event(this.constructor.Event.HIDE), s = function () {
                ...
                if (i.default(this.element).trigger(a), !a.isDefaultPrevented()) {
                    if (i.default(n).removeClass("show"), "ontouchstart" in document.documentElement && i.default(document.body).children().off("mouseover", null, i.default.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, i.default(this.tip).hasClass("fade")) {
                        var o = r.getTransitionDurationFromElement(n);
                        i.default(n).one(r.TRANSITION_END, s).emulateTransitionEnd(o)
                    } else s();
                    this._hoverState = ""
                }
            }, t.update = function () {
                ...
                "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Ae(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? i.default(t).parent().is(e) || e.empty().append(t) : e.text(i.default(t).text())
            }, t.getTitle = function () {
                ...
                return Object.keys(t).forEach((function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), r.typeCheckConfig(De, e, this.constructor.DefaultType), e.sanitize && (e.template = Ae(e.template, e.whiteList, e.sanitizeFn)), e
            }, t._getDelegateConfig = function () {
                var e = {};
                if (this.config) for (var t in this.config) this.constructor.Default[t] !== this.config[t] && (e[t] = this.config[t]);
                return e
            }, t._cleanTipClass = function () {
                var e = i.default(this.getTipElement()), t = e.attr("class").match($e);
                ...
                return this.each((function () {
                    var n = i.default(this), a = n.data("bs.tooltip"), s = "object" == typeof t && t;
                    if ((a || !/dispose|hide/.test(t)) && (a || (a = new e(this, s), n.data("bs.tooltip", a)), "string" == typeof t)) {
                        if (void 0 === a[t]) throw new TypeError('No method named "' + t + '"');
                        a[t]()
                    }
                }))
    ...
    i.default.fn[De] = qe._jQueryInterface, i.default.fn[De].Constructor = qe, i.default.fn[De].noConflict = function () {
        return i.default.fn[De] = Ne, qe._jQueryInterface
    };
    var We = "popover", Ve = i.default.fn[We], Ue = new RegExp("(^|\\s)bs-popover\\S+", "g"), Ge = s({}, qe.Default, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
    }), Xe = s({}, qe.DefaultType, {content: "(string|element|function)"}), Ke = {
        ...
        return r.isWithContent = function () {
            ...
            var e = i.default(this.getTipElement()), t = e.attr("class").match(Ue);
            null !== t && t.length > 0 && e.removeClass(t.join(""))
        }, s._jQueryInterface = function (e) {
            return this.each((function () {
                var t = i.default(this).data("bs.popover"), n = "object" == typeof e ? e : null;
                if ((t || !/dispose|hide/.test(e)) && (t || (t = new s(this, n), i.default(this).data("bs.popover", t)), "string" == typeof e)) {
    ...
    i.default.fn[We] = Ze._jQueryInterface, i.default.fn[We].Constructor = Ze, i.default.fn[We].noConflict = function () {
        return i.default.fn[We] = Ve, Ze._jQueryInterface
    };
    var Je = "scrollspy", et = i.default.fn[Je], tt = {offset: 10, method: "auto", target: ""},
        it = {offset: "number", method: "string", target: "(string|element)"}, nt = function () {
            function e(e, t) {
                var n = this;
            ...
            return t.refresh = function () {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map((function (e) {
                    var t, s = r.getSelectorFromElement(e);
                    if (s && (t = document.querySelector(s)), t) {
                        var o = t.getBoundingClientRect();
                        if (o.width || o.height) return [i.default(t)[n]().top + a, s]
                    }
                    return null
                })).filter((function (e) {
                    return e
                ...
                if ("string" != typeof (e = s({}, tt, "object" == typeof e && e ? e : {})).target && r.isElement(e.target)) {
                    var t = i.default(e.target).attr("id");
                    t || (t = r.getUID(Je), i.default(e.target).attr("id", t)), e.target = "#" + t
                }
                return r.typeCheckConfig(Je, e, it), e
    ...
    })), i.default.fn[Je] = nt._jQueryInterface, i.default.fn[Je].Constructor = nt, i.default.fn[Je].noConflict = function () {
        return i.default.fn[Je] = et, nt._jQueryInterface
    };
    var at = i.default.fn.tab, st = function () {
        function e(e) {
            this._element = e
        }
        ...
        return t.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && i.default(this._element).hasClass("active") || i.default(this._element).hasClass("disabled"))) {
                ...
                if (n && i.default(n).trigger(l), i.default(this._element).trigger(d), !d.isDefaultPrevented() && !l.isDefaultPrevented()) {
                    s && (t = document.querySelector(s)), this._activate(this._element, a);
                    var c = function () {
            ...
            var a = this,
                s = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? i.default(t).children(".active") : i.default(t).find("> li > .active"))[0],
                o = n && s && i.default(s).hasClass("fade"), l = function () {
                    return a._transitionComplete(e, s, n)
                };
            if (s && o) {
                var d = r.getTransitionDurationFromElement(s);
                i.default(s).removeClass("show").one(r.TRANSITION_END, l).emulateTransitionEnd(d)
            } else l()
            ...
            if (i.default(e).addClass("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), r.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && i.default(e.parentNode).hasClass("dropdown-menu")) {
                var s = i.default(e).closest(".dropdown")[0];
                if (s) {
    ...
    i.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function (e) {
        ...
        return i.default.fn.tab = at, st._jQueryInterface
    };
    var rt = i.default.fn.toast, ot = {animation: "boolean", autohide: "boolean", delay: "number"},
        lt = {animation: !0, autohide: !0, delay: 500}, dt = function () {
            function e(e, t) {
            ...
            return t.show = function () {
                ...
                if (i.default(this._element).trigger(t), !t.isDefaultPrevented()) {
                    ...
                    if (this._element.classList.remove("hide"), r.reflow(this._element), this._element.classList.add("showing"), this._config.animation) {
                        var a = r.getTransitionDurationFromElement(this._element);
                        i.default(this._element).one(r.TRANSITION_END, n).emulateTransitionEnd(a)
                    } else n()
                }
            }, t.hide = function () {
                ...
                return e = s({}, lt, i.default(this._element).data(), "object" == typeof e && e ? e : {}), r.typeCheckConfig("toast", e, this.constructor.DefaultType), e
            }, t._setListeners = function () {
                var e = this;
                ...
                if (this._element.classList.remove("show"), this._config.animation) {
                    ...
                    i.default(this._element).one(r.TRANSITION_END, t).emulateTransitionEnd(n)
                } else t()
    ...
    i.default.fn.toast = dt._jQueryInterface, i.default.fn.toast.Constructor = dt, i.default.fn.toast.noConflict = function () {
        return i.default.fn.toast = rt, dt._jQueryInterface
    }, e.Alert = d, e.Button = u, e.Carousel = v, e.Collapse = _, e.Dropdown = ke, e.Modal = Le, e.Popover = Ze, e.Scrollspy = nt, e.Tab = st, e.Toast = dt, e.Tooltip = qe, e.Util = r, Object.defineProperty(e, "__esModule", {value: !0})
}, "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = {}, t.jQuery), window.scwAccordionsPlugin = window.scwAccordionsPlugin || {}, window.SEMICOLON_accordionsInit = function (e) {
    ...
    e.each((function () {
        ...
        n = Number(n) - 1, void 0 !== r && "" != r && (e = t.find(".accordion-header" + r), e.length > 0 && (n = e.index() / 2)), t.find(".accordion-content").hide(), "closed" != i && t.find(".accordion-header:eq(" + Number(n) + ")").addClass("accordion-active " + a).next().show(), t.find(".accordion-header").off("click").on("click", (function () {
            if ($(this).next().is(":hidden")) {
                t.find(".accordion-header").removeClass("accordion-active " + a).next().slideUp("normal");
                let e = $(this);
                $(this).toggleClass("accordion-active " + a).next().stop(!0, !0).slideDown("normal", (function () {
            ...
            } else "true" == s && $(this).toggleClass("acctitlec").next().stop(!0, !0).slideUp("normal");
            return !1
        }))
    }))
}, a = function (e) {
    e.extend(e.fn, {
        validate: function (t) {
            ...
            var n, a, s, r, o, l, d = this[0],
                c = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
            if (null != d && (!d.form && c && (d.form = this.closest("form")[0], d.name = this.attr("name")), null != d.form)) {
                if (t) switch (n = e.data(d.form, "validator").settings, a = n.rules, s = e.validator.staticRules(d), t) {
                    case"add":
                        e.extend(s, e.validator.normalizeRule(i)), delete s.messages, a[d.name] = s, i.messages && (n.messages[d.name] = e.extend(n.messages[d.name], i.messages));
                        break;
                    case"remove":
                ...
                return (r = e.validator.normalizeRules(e.extend({}, e.validator.classRules(d), e.validator.attributeRules(d), e.validator.dataRules(d), e.validator.staticRules(d)), d)).required && (o = r.required, delete r.required, r = e.extend({required: o}, r)), r.remote && (o = r.remote, delete r.remote, r = e.extend(r, {remote: o})), r
            }
        }
    });
    var t = function (e) {
    ...
    e.extend(e.expr.pseudos || e.expr[":"], {
            ...
            init: function () {
                function t(t) {
                    ...
                    if (!this.form && i && (this.form = e(this).closest("form")[0], this.name = e(this).attr("name")), n === this.form) {
                        var a = e.data(this.form, "validator"), s = "on" + t.type.replace(/^validate/, ""),
                            r = a.settings;
                ...
                var i, n, a = this.clean(t), s = this.validationTargetFor(a), r = this, o = !0;
                ...
                var i, n, a = e(t), s = t.type,
                    r = void 0 !== a.attr("contenteditable") && "false" !== a.attr("contenteditable");
                return "radio" === s || "checkbox" === s ? this.findByName(t.name).filter(":checked").val() : "number" === s && void 0 !== t.validity ? t.validity.badInput ? "NaN" : a.val() : (i = r ? a.text() : a.val(), "file" === s ? "C:\\fakepath\\" === i.substr(0, 12) ? i.substr(12) : (n = i.lastIndexOf("/")) >= 0 || (n = i.lastIndexOf("\\")) >= 0 ? i.substr(n + 1) : i : "string" == typeof i ? i.replace(/\r/g, "") : i)
            }, check: function (t) {
                t = this.validationTargetFor(this.clean(t));
                var i, n, a, s, r = e(t).rules(), o = e.map(r, (function (e, t) {
                    return t
                })).length, l = !1, d = this.elementValue(t);
                for (n in "function" == typeof r.normalizer ? s = r.normalizer : "function" == typeof this.settings.normalizer && (s = this.settings.normalizer), s && (d = s.call(t, d), delete r.normalizer), r) {
                ...
                var n, a, s, r, o = this.errorsFor(t), l = this.idOrName(t), d = e(t).attr("aria-describedby");
        ...
        attributeRules: function (t) {
            var i, n, a = {}, s = e(t), r = t.getAttribute("type");
        ...
        methods: {
            required: function (t, i, n) {
                ...
                var a, s = e(i).attr("type"), r = "Step attribute on input type " + s + " is not supported.",
                    o = new RegExp("\\b" + s + "\\b"), l = function (e) {
                        var t = ("" + e).match(/(?:\.(\d+))?$/);
                ...
                return this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), l.originalMessage = l.originalMessage || this.settings.messages[i.name][a], this.settings.messages[i.name][a] = l.message, n = "string" == typeof n && {url: n} || n, o = e.param(e.extend({data: t}, n.data)), l.old === o ? l.valid : (l.old = o, s = this, this.startRequest(i), (r = {})[i.name] = t, e.ajax(e.extend(!0, {
                    mode: "abort",
                    ...
                    success: function (e) {
                        ...
                        s.settings.messages[i.name][a] = l.originalMessage, d ? (o = s.formSubmitted, s.resetInternals(), s.toHide = s.errorsFor(i), s.formSubmitted = o, s.successList.push(i), s.invalid[i.name] = !1, s.showErrors()) : (n = {}, r = e || s.defaultMessage(i, {
                            method: a,
                            parameters: t
    ...
    return e.ajaxPrefilter ? e.ajaxPrefilter((function (e, t, i) {
        ...
        var a = ("mode" in t ? t : e.ajaxSettings).mode, s = ("port" in t ? t : e.ajaxSettings).port;
        return "abort" === a ? (n[s] && n[s].abort(), n[s] = i.apply(this, arguments), n[s]) : i.apply(this, arguments)
    }), e
}, "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == typeof module && module.exports ? module.exports = a(require("jquery")) : a(jQuery), r = function (e) {
    var t = /\r?\n/g, i = {};
    ...
    e.fn.attr2 = function () {
        ...
        t.resetForm && C.push((function () {
            ...
            for (var a = t.context || this, s = 0, r = C.length; s < r; s++) C[s].apply(a, [e, i, n || h, h])
        ...
        function O(i) {
            var a, s, o, d, c, u, p, f, m, g, y, b, w = h[0], T = e.Deferred();
            ...
            var S = e("meta[name=csrf-token]").attr("content"), E = e("meta[name=csrf-param]").attr("content");
            ...
            function P() {
                ...
                var a = [];
                try {
                    if (o.extraData) for (var s in o.extraData) o.extraData.hasOwnProperty(s) && (e.isPlainObject(o.extraData[s]) && o.extraData[s].hasOwnProperty("name") && o.extraData[s].hasOwnProperty("value") ? a.push(e('<input type="hidden" name="' + o.extraData[s].name + '">', _).val(o.extraData[s].value).appendTo(w)[0]) : a.push(e('<input type="hidden" name="' + s + '">', _).val(o.extraData[s]).appendTo(w)[0]));
                    o.iframeTarget || u.appendTo(C), p.attachEvent ? p.attachEvent("onload", L) : p.addEventListener("load", L, !1), setTimeout((function e() {
                        try {
                            var t = x(p).readyState;
                            r("state = " + t), t && "uninitialized" === t.toLowerCase() && setTimeout(e, 50)
                        } catch (e) {
                            r("Server abort: ", e, " (", e.name, ")"), L(2), b && clearTimeout(b), b = void 0
                        }
                    }), 15);
                    try {
                        w.submit()
            ...
            E && S && (o.extraData = o.extraData || {}, o.extraData[E] = S), o.forceSync ? P() : setTimeout(P, 10);
            var k, I, M, O = 50;

            function L(t) {
                if (!f.aborted && !M) {
                    if ((I = x(p)) || (r("cannot access response document"), t = 2), 1 === t && f) return f.abort("timeout"), void T.reject(f, "timeout");
                    if (2 === t && f) return f.abort("server abort"), void T.reject(f, "error", "server abort");
                    if (I && I.location.href !== o.iframeSrc || y) {
                        p.detachEvent ? p.detachEvent("onload", L) : p.removeEventListener("load", L, !1);
                        var i, n = "success";
                        try {
                            if (y) throw"timeout";
                            var a = "xml" === o.dataType || I.XMLDocument || e.isXMLDoc(I);
                            if (r("isXml=" + a), !a && window.opera && (null === I.body || !I.body.innerHTML) && --O) return r("requeing onLoad callback, DOM not available"), void setTimeout(L, 250);
                            var s = I.body ? I.body : I.documentElement;
                            f.responseText = s ? s.innerHTML : null, f.responseXML = I.XMLDocument ? I.XMLDocument : I, a && (o.dataType = "xml"), f.getResponseHeader = function (e) {
            ...
            var j = e.parseXML || function (e, t) {
                ...
                return s && "parsererror" === r.documentElement.nodeName && e.error && e.error("parsererror"), n && n.dataFilter && (r = n.dataFilter(r, i)), "string" == typeof r && (("json" === i || !i) && 0 <= a.indexOf("json") ? r = z(r) : ("script" === i || !i) && 0 <= a.indexOf("javascript") && e.globalEval(r)), r
            };
            return T
        }
        ...
        var r, o, l, d, c, u, h, p, f, m, g = this[0], v = this.attr("id"),
        ...
        for (e.isFunction(a) && (y = e.map(y, a)), o = 0, u = y.length; o < u; o++) if ((m = (c = y[o]).name) && !c.disabled) if (t && g.clk && "image" === c.type) g.clk === c && (s.push({
            name: m,
            value: e(c).val(),
            type: c.type
            ...
            name: m + ".y",
            value: g.clk_y
        })); else if ((d = e.fieldValue(c, !0)) && d.constructor === Array) for (n && n.push(c), l = 0, h = d.length; l < h; l++) s.push({
            name: m,
            value: d[l]
            ...
            if (b.length) for (l = 0; l < b.length; l++) s.push({
                ...
                value: b[l],
                type: c.type
            }); else s.push({name: m, value: "", type: c.type})
        } else null != d && (n && n.push(c), s.push({name: m, value: d, type: c.type, required: c.required}));
        ...
        if (o < 0) return null;
        for (var l = [], d = i.options, c = "select-one" === s, u = c ? o + 1 : d.length, h = c ? o : 0; h < u; h++) {
            var p = d[h];
...
} : r(jQuery), window.scwAjaxFormPlugin = window.scwAjaxFormPlugin || {}, window.SEMICOLON_ajaxFormInit = function (e) {
    if ((e = e.filter(":not(.customjs)")).length < 1) return !0;
    e.each((function () {
        ...
        s || (s = "notify"), a && n.addClass(a + "-ready"), i.find("form").validate({
            ...
            }, focusCleanup: !0, submitHandler: function (i) {
                o.hide(), "button" == r ? (e = $(i).find("button"), defButtonText = e.html(), e.html('<i class="icon-line-loader icon-spin m-0"></i>')) : $(i).find(".form-process").fadeIn(), a && n.removeClass(a + "-ready " + a + "-complete " + a + "-success " + a + "-error").addClass(a + "-processing"), $(i).ajaxSubmit({
                    target: o, dataType: "json", success: function (d) {
                        if ("button" == r ? e.html(defButtonText) : $(i).find(".form-process").fadeOut(), "error" != d.alert && l) return window.location.replace(l), !0;
                        if ("inline" == s ? (t = "error" == d.alert ? "alert-danger" : "alert-success", o.removeClass("alert-danger alert-success").addClass("alert " + t).html(d.message).slideDown(400)) : "notify" == s && (o.attr("data-notify-type", d.alert).attr("data-notify-msg", d.message).html(""), SEMICOLON.widget.notifications({el: o})), "error" != d.alert) {
                            $(i).resetForm(), $(i).find(".btn-group > .btn").removeClass("active"), "undefined" != typeof tinyMCE && tinyMCE.activeEditor && !tinyMCE.activeEditor.isHidden() && tinymce.activeEditor.setContent("");
                            let e = $(i).find(".input-range-slider");
                            e.length > 0 && e.each((function () {
                                $(this).data("ionRangeSlider").reset()
                            }));
                            let t = $(i).find(".input-rating");
                            t.length > 0 && t.each((function () {
                                $(this).rating("reset")
                            }));
                            let s = $(i).find(".selectpicker");
                            s.length > 0 && s.each((function () {
                                $(this).selectpicker("val", ""), $(this).selectpicker("deselectAll")
                            })), $(i).find(".input-select2,select[data-selectsplitter-firstselect-selector]").change(), $(i).trigger("formSubmitSuccess"), n.removeClass(a + "-error").addClass(a + "-success")
                        } else $(i).trigger("formSubmitError"), n.removeClass(a + "-success").addClass(a + "-error");
                        a && n.removeClass(a + "-processing").addClass(a + "-complete"), $(i).find(".g-recaptcha").children("div").length > 0 && grecaptcha.reset()
                    }
                })
            }
        })
...
window.SEMICOLON_portfolioAjaxloadInit = function () {
    ...
    if ((e = e.filter(":not(.customjs)")).length < 1) return !0;
    let t = "animated", i = new IntersectionObserver((function (e, t) {
            ...
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": e.proxy((function (t) {
                if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type)) {
                    var i = this._core.settings, n = i.center && Math.ceil(i.items / 2) || i.items,
                        a = i.center && -1 * n || 0,
                        s = (t.property && undefined !== t.property.value ? t.property.value : this._core.current()) + a,
    ...
    a.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, a.prototype.fetch = function (e, t) {
        ...
        var n, a, s = i.width && i.height ? "width:" + i.width + "px;height:" + i.height + "px;" : "",
            r = t.find("img"), o = "src", l = "", d = this._core.settings, c = function (i) {
        ...
        if (t.wrap(e("<div/>", {
            ...
            style: s
        })), this._core.settings.lazyLoad && (o = "data-src", l = "owl-lazy"), r.length) return c(r.attr(o)), r.remove(), !1;
    ...
    function a(t, i) {
        ...
        return e.each((t + " " + o.join(a + " ") + a).split(" "), (function (e, t) {
            if (undefined !== r[t]) return n = !i || t, !1
        })), n
    }
    ...
    (function () {
        return !!a("transition")
    })() && (e.support.transition = new String(s("transition")), e.support.transition.end = l.transition.end[e.support.transition]), u() && (e.support.animation = new String(s("animation")), e.support.animation.end = l.animation.end[e.support.animation]), d() && (e.support.transform = new String(s("transform")), e.support.transform3d = c())
    ...
    return function i(n) {
        ...
        function s(t, i, s) {
            if ("undefined" != typeof document) {
                "number" == typeof (s = e({path: "/"}, a.defaults, s)).expires && (s.expires = new Date(1 * new Date + 864e5 * s.expires)), s.expires = s.expires ? s.expires.toUTCString() : "";
                try {
        ...
        function r(e, i) {
            if ("undefined" != typeof document) {
                for (var a = {}, s = document.cookie ? document.cookie.split("; ") : [], r = 0; r < s.length; r++) {
                    var o = s[r].split("="), l = o.slice(1).join("=");
        ...
        return a.set = s, a.get = function (e) {
            return r(e, !1)
    ...
    if ((e = e.filter(".gdpr-settings:not(.customjs)")).length < 1) return !0;
    e.attr("data-speed");
    let t, i = e.attr("data-expire") || 30, n = e.attr("data-delay") || 1500, a = e.attr("data-persistent"),
        s = "bottom", r = e.outerHeight() + 100, o = e.outerWidth() + 100, l = {};
    "true" == a && Cookies.set("websiteUsesCookies", ""), e.hasClass("gdpr-settings-sm") && e.hasClass("gdpr-settings-right") ? s = "right" : e.hasClass("gdpr-settings-sm") && (s = "left"), "left" == s ? (t = -o, l = {
        left: t,
        right: "auto"
    }, l.marginLeft = "1rem") : "right" == s ? (t = -o, l = {
        right: t,
        left: "auto"
    }, l.marginRight = "1rem") : (t = -r, l[s] = t), e.css(l), "yesConfirmed" != Cookies.get("websiteUsesCookies") && (l[s] = 0, l.opacity = 1, setTimeout((function () {
        e.css(l)
    }), Number(n))), $(".gdpr-accept").off("click").on("click", (function () {
        return l[s] = t, l.opacity = 0, e.css(l), Cookies.set("websiteUsesCookies", "yesConfirmed", {expires: Number(i)}), !1
    }))
}, j = !1, window.JQClass = function () {
}, JQClass.classes = {}, JQClass.extend = function e(t) {
    var i = this.prototype;
    j = !0;
    var n = new this;
    for (var a in j = !1, t) n[a] = "function" == typeof t[a] && "function" == typeof i[a] ? function (e, t) {
        return function () {
            var n = this._super;
    ...
    return s.prototype = n, s.prototype.constructor = s, s.extend = e, s
}, function ($) {
    ...
    e.JQPlugin.createPlugin({
        ...
        _determineTime: function (e, t) {
            var i = this, n = this._eqNull(e) ? t : "string" == typeof e ? function (e) {
                e = e.toLowerCase();
                for (var t = new Date, n = t.getFullYear(), a = t.getMonth(), s = t.getDate(), r = t.getHours(), o = t.getMinutes(), l = t.getSeconds(), d = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, c = d.exec(e); c;) {
                    switch (c[2] || "s") {
                        case"s":
                            l += parseInt(c[1], 10);
                            break;
                        ...
                        case"w":
                            ...
                            break;
                        case"o":
                            a += parseInt(c[1], 10), s = Math.min(s, i._getDaysInMonth(n, a));
                            break;
                        case"y":
                            n += parseInt(c[1], 10), s = Math.min(s, i._getDaysInMonth(n, a))
                    }
                    c = d.exec(e)
                }
        ...
        _generateHTML: function (t) {
            ...
            var d = t.options.compact ? t.options.compactLabels : t.options.labels,
                c = t.options.whichLabels || this._normalLabels, u = function (e) {
                    ...
                    return r[e] ? i._translateDigits(t, t._periods[e]) + (n ? n[e] : d[e]) + " " : ""
                }, h = t.options.padZeroes ? 2 : 1, p = function (e) {
                    var n = t.options["labels" + c(t._periods[e])];
                    return !t.options.significant && r[e] || t.options.significant && l[e] ? '<span class="' + i._sectionClass + '"><span class="' + i._amountClass + '">' + i._minDigits(t, t._periods[e], h) + '</span><span class="' + i._periodClass + '">' + (n ? n[e] : d[e]) + "</span></span>" : ""
                };
        ...
        _calculatePeriods: function (e, t, i, n) {
            ...
            if (t[0] || t[1]) {
                ...
                s[0] = t[0] ? Math.floor(c / 12) : 0, s[1] = t[1] ? c - 12 * s[0] : 0;
    ...
    e.each((function () {
        ...
        n && (c = n), a && a < 13 ? c = c + "-" + (a < 10 ? "0" + a : a) : n && (c += "-01"), s && s < 32 ? c = c + "-" + (s < 10 ? "0" + s : s) : n && (c += "-01"), setDate = "" != c ? new Date(moment(c)) : new Date, r && r < 25 && setDate.setHours(setDate.getHours() + Number(r)), o && o < 60 && setDate.setMinutes(setDate.getMinutes() + Number(o)), l && l < 60 && setDate.setSeconds(setDate.getSeconds() + Number(l)), d || (d = !1), "true" == i ? e.countdown({
            since: setDate,
            format: t,
            expiryUrl: d
    ...
    e.fn.countTo = function (t) {
        return t = t || {}, e(this).each((function () {
            ...
            o.data("countTo", c), c.interval && clearInterval(c.interval), c.interval = setInterval((function () {
                l++, i(d += s), "function" == typeof n.onUpdate && n.onUpdate.call(r, d), l >= a && (o.removeData("countTo"), clearInterval(c.interval), d = n.to, "function" == typeof n.onComplete && n.onComplete.call(r, d))
    ...
    e.jribbble.shots = function (t, i) {
        var n = c([].slice.call(arguments)) || {}, a = i || {}, s = function (t) {
            return function (i, n) {
                var a = c([].slice.call(arguments)) || {}, s = n || {};
                return this.queue.add((function (i) {
                    if (!i.shotId) throw new Error(r.shotId(t));
                    i.url += "/" + t + "/", a.resource && (i.url += a.resource, delete a.resource), i.url += d(e.extend(a, s))
                })), this
            }
        }, o = function () {
        ...
        e.data(i, "flexslider", a), g = {
            init: function () {
                ...
                setup: function () {
                    ...
                    a.customDirectionNav ? a.directionNav = a.customDirectionNav : a.controlsContainer ? (e(a.controlsContainer).append(t), a.directionNav = e("." + r + "direction-nav li a", a.controlsContainer)) : (a.append(t), a.directionNav = e("." + r + "direction-nav li a", a)), g.directionNav.update(), a.directionNav.bind(d, (function (t) {
                        var i;
                        t.preventDefault(), "" !== c && c !== t.type || (i = e(this).hasClass(r + "next") ? a.getTarget("next") : a.getTarget("prev"), a.flexAnimate(i, a.vars.pauseOnAction)), "" === c && (c = t.type), g.setToClearWatchedEvent()
                    }))
                }, update: function () {
                    var e = r + "disabled";
                ...
                setup: function () {
                    ...
                    a.controlsContainer ? (a.controlsContainer.append(t), a.pausePlay = e("." + r + "pauseplay a", a.controlsContainer)) : (a.append(t), a.pausePlay = e("." + r + "pauseplay a", a)), g.pausePlay.update(a.vars.slideshow ? r + "pause" : r + "play"), a.pausePlay.bind(d, (function (t) {
                        t.preventDefault(), "" !== c && c !== t.type || (e(this).hasClass(r + "pause") ? (a.manualPause = !0, a.manualPlay = !1, a.pause()) : (a.manualPause = !1, a.manualPlay = !0, a.play())), "" === c && (c = t.type), g.setToClearWatchedEvent()
                    }))
                }, update: function (e) {
                ...
                var e, t, n, s, r, l, d, c, m, g = !1, v = 0, y = 0, b = 0;
                o ? (i.style.msTouchAction = "none", i._gesture = new MSGesture, i._gesture.target = i, i.addEventListener("MSPointerDown", (function (e) {
                    ...
                    if (a) {
                        if (a.animatingTo === a.currentSlide && !g && null !== r) {
                            var o = h ? -r : r, d = o > 0 ? a.getTarget("next") : a.getTarget("prev");
                            a.canAdvance(d) && (Number(new Date) - l < 550 && Math.abs(o) > 50 || Math.abs(o) > s / 2) ? a.flexAnimate(d, a.vars.pauseOnAction) : f || a.flexAnimate(a.currentSlide, a.vars.pauseOnAction, !0)
                        }
                    ...
                    if (i.removeEventListener("touchmove", c, !1), a.animatingTo === a.currentSlide && !g && null !== r) {
                        var d = h ? -r : r, u = d > 0 ? a.getTarget("next") : a.getTarget("prev");
                        a.canAdvance(u) && (Number(new Date) - l < 550 && Math.abs(d) > 50 || Math.abs(d) > s / 2) ? a.flexAnimate(u, a.vars.pauseOnAction) : f || a.flexAnimate(a.currentSlide, a.vars.pauseOnAction, !0)
                    }
            ...
            if (a.vars.animationLoop || t === a.currentSlide || (a.direction = t > a.currentSlide ? "next" : "prev"), m && 1 === a.pagingCount && (a.direction = a.currentItem < t ? "next" : "prev"), !a.animating && (a.canAdvance(t, o) || n) && a.is(":visible")) {
                if (m && s) {
                    ...
                    if (a.atEnd = 0 === t || t === a.count - 1, d.flexAnimate(t, !0, !1, !0, o), a.direction = a.currentItem < t ? "next" : "prev", d.direction = a.direction, Math.ceil((t + 1) / a.visible) - 1 === a.currentSlide || 0 === t) return a.currentItem = t, a.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), !1;
    ...
    e.each((function () {
        ...
        "swing" == n && (n = "swing", y = !0), s = "true" == s, r = !r, d || (d = !1), g = "false" != g, "vertical" == a && (g = !1), c = "false" != c, c = "true" == f ? "thumbnails" : c, u = "false" != u, m = "false" != m, v = "false" != v, e.find(".flexslider").flexslider({
    ...
    e.fn.gMap = function (t, i) {
        ...
        return this.each((function () {
            ...
            })), e(this).bind("gMap.addMarker", (function (e, i, a, s, r, c) {
    ...
    e.each((function () {
        ...
        l && (l = JSON.parse(l)), "false" == s && (s = !1), "true" == u && (u = !0), "true" == h && (h = !0), "true" == p && (p = !0), "true" == f && (f = !0), "true" == m && (m = !0), "true" == g && (g = !0), d = d ? Function("return " + d)() : n ? [{
            address: n,
            html: a || n
        }] : [{
            latitude: t,
    ...
    e.each((function () {
        ...
        let o, l, d = 0;
        a && (d = Number(a)), n && e.css({"animation-duration": Number(n) + "ms"}), s.hover((function () {
    ...
    if (e.length < 1) return !0;
    e.each((function () {
        let e = $(this), t = e.attr("data-user"), i = e.attr("data-count") || 12;
        Number(i) > 12 && (i = 12), SEMICOLON_getInstagramPhotos(e, t, i, "", !1)
    }))
}, window.SEMICOLON_getInstagramPhotos = function (e, t, i, n, a) {
    return $.getJSON("https://www.instagram.com/" + t + "/?__a=1" + n, (function (s) {
        let r = s.graphql.user, o = r.edge_owner_to_timeline_media;
        if (r.is_private) return console.log("Private Account!"), !1;
        if (a = a ? a.concat(o.edges) : o.edges, "" != n && (n = "&max_id=" + o.page_info.end_cursor), a.length < i && (a = SEMICOLON_getInstagramPhotos(e, t, i, n, a)), a.length > 0) {
            let t = "";
            for (let e = 0; e < i; e++) {
                if (e === i) continue;
                let n = a[e];
    ...
    function n(n) {
        if (i(), "string" == typeof n && (n = document.querySelector(n)), n && "object" == typeof n && n.nodeType) {
            ...
            for (var d = l.isBorderBox = "border-box" == s.boxSizing, c = 0; c < o; c++) {
                var u = r[c], h = s[u], p = parseFloat(h);
                l[u] = isNaN(p) ? 0 : p
            }
    ...
    return n._resetLayout = function () {
        ...
        for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, d = r; d <= o; d++) this.colYs[d] = Math.max(l, this.colYs[d])
    ...
    var u = function (e) {
        ...
        }(n && n[1], i), s = d.sortDataParsers[t[1]];
        return s ? function (e) {
            return e && s(a(e))
        } : function (e) {
            return e && a(e)
    ...
    var t = "undefined" != typeof window,
        ...
        s = t && window.devicePixelRatio > 1, r = {
            ...
            S(e, "sizes", d(e, t.data_sizes)), S(e, "srcset", d(e, t.data_srcset)), S(e, "src", d(e, t.data_src))
        }, O = function (e) {
            ...
            IMG: function (e, t) {
                ...
                S(e, "src", d(e, t.data_src))
            }, VIDEO: function (e, t) {
                j(e, (function (e) {
                    S(e, "src", d(e, t.data_src))
                })), S(e, "poster", d(e, t.data_poster)), S(e, "src", d(e, t.data_src)), e.load()
            }
        }, Y = function (e, t) {
            var i = z[e.tagName];
            i && i(e, t)
        }, A = function (e, t, i) {
            _(i, 1), y(e, t.class_loading), h(e, "loading"), v(t.callback_loading, e, i)
        }, D = {
            IMG: function (e, t) {
                c(e, t.data_src, null), c(e, t.data_srcset, null), c(e, t.data_sizes, null), L(e, (function (e) {
                    c(e, t.data_srcset, null), c(e, t.data_sizes, null)
                }))
            }, IFRAME: function (e, t) {
                c(e, t.data_src, null)
            }, VIDEO: function (e, t) {
                c(e, t.data_src, null), c(e, t.data_poster, null), j(e, (function (e) {
                    c(e, t.data_src, null)
                }))
            }
        }, N = function (e, t) {
            ...
            i ? i(e, t) : function (e, t) {
                c(e, t.data_bg, null), c(e, t.data_bg_hidpi, null)
            }(e, t)
        }, $ = ["IMG", "IFRAME", "VIDEO"], B = function (e, t) {
            !t || function (e) {
            ...
            !function (e) {
                ...
                e && (e.toLoadCount -= 1)
            }(i), b(e, t.class_loading), t.unobserve_completed && T(e, i)
        }, W = function (e, t, i) {
            var n = w(e) || e;
            F(n) || function (e, t, i) {
                F(e) || (e.llEvLisnrs = {});
                ...
                !function (e, t, i, n) {
                    var a = m(t);
                    q(t, i, n), y(t, i.class_loaded), h(t, "loaded"), N(t, i), v(i.callback_loaded, t, n), a || B(i, n)
                }(0, e, t, i), H(n)
            }), (function (a) {
                !function (e, t, i, n) {
                    var a = m(t);
                    q(t, i, n), y(t, i.class_error), h(t, "error"), v(i.callback_error, t, n), a || B(i, n)
                }(0, e, t, i), H(n)
            }))
        }, V = function (e, t, i) {
            !function (e) {
                e.llTempImage = document.createElement("IMG")
            }(e), W(e, t, i), function (e, t, i) {
                var n = d(e, t.data_bg), a = d(e, t.data_bg_hidpi), r = s && a ? a : n;
                r && (e.style.backgroundImage = 'url("'.concat(r, '")'), w(e).setAttribute("src", r), A(e, t, i))
            }(e, t, i), function (e, t, i) {
                var n = d(e, t.data_bg_multi), a = d(e, t.data_bg_multi_hidpi), r = s && a ? a : n;
                r && (e.style.backgroundImage = r, function (e, t, i) {
                    y(e, t.class_applied), h(e, "applied"), function (e, t) {
                        c(e, t.data_bg_multi, null), c(e, t.data_bg_multi_hidpi, null)
                    }(e, t), t.unobserve_completed && T(e, t), v(t.callback_applied, e, i)
                }(e, t, i))
            }(e, t, i)
        }, U = function (e, t, i) {
            !function (e) {
                    ...
                    !function (e, t, i) {
                        e.forEach((function (e) {
                            return function (e) {
                                ...
                                h(e, "entered"), function (e, t, i) {
                                    t.unobserve_entered && T(e, i)
                                ...
                                f(e) || (function (e, t, i, n) {
                                    i.cancel_on_exit && function (e) {
                                        return "loading" === u(e)
                                    }(e) && "IMG" === e.tagName && (H(e), function (e) {
                                        L(e, (function (e) {
                                            O(e)
                                        })), O(e)
                                    }(e), function (e) {
                                    ...
                                    }(e), b(e, i.class_loading), _(n, -1), p(e), v(i.callback_cancel, e, t, n))
    ...
    return te.prototype = {
        update: function (e) {
            ...
            C(this, r.length), !i && n ? X(s) ? function (e, t, i) {
                e.forEach((function (e) {
                    -1 !== G.indexOf(e.tagName) && (e.setAttribute("loading", "lazy"), function (e, t, i) {
                        W(e, t, i), Y(e, t), N(e, t), h(e, "native")
                    }(e, t, i))
                })), C(i, 0)
            }(r, s, this) : (a = r, function (e) {
                e.disconnect()
    ...
    var t, i, n, a, s, r, o = "Close", l = "BeforeClose", d = "MarkupParse", c = "Open", u = "Change", h = "mfp",
        p = "." + h, f = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function () {
    ...
    v.prototype = {
        constructor: v, init: function () {
            ...
            if (!t.isOpen) {
                ...
                _("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (w(d, (function (e, t, i, n) {
                ...
                }), 16), t.isOpen = !0, t.updateSize(h), _(c), i
            }
            t.updateItemHTML()
        }, close: function () {
            ...
            if (_("BeforeChange", [t.currItem ? t.currItem.type : "", n]), t.currItem = i, !t.currTemplate[n]) {
                ...
                _("FirstMarkupParse", s), t.currTemplate[n] = !s || e(s)
            }
            a && a !== i.type && t.container.removeClass("mfp-" + a + "-holder");
            var r = t["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, t.currTemplate[n]);
            t.appendContent(r, n), i.preloaded = !0, _(u, i), a = i.type, t.container.prepend(t.contentContainer), _("AfterChange")
        }, appendContent: function (e, i) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(C()) : t.content = e : t.content = "", _("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
        }, parseEl: function (i) {
            var n, a = t.items[i];
            ...
            return a.type = n || t.st.type || "inline", a.index = i, a.parsed = !0, t.items[i] = a, _("ElementParse", a), t.items[i]
            ...
            if (t.preloader) {
                ...
                _("UpdateStatus", a), e = a.status, n = a.text, t.preloader.html(n), t.preloader.find("a").on("click", (function (e) {
        ...
        if ("string" == typeof i) if ("open" === i) {
            var a, s = y ? n.data("magnificPopup") : n[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
            ...
            initInline: function () {
                ...
                if (I(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (E || (S = a.hiddenClass, E = T(S), S = "mfp-" + S), P = s.after(E).detach().removeClass(S)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(O, {
        options: {
            ...
            initAjax: function () {
                t.types.push(O), M = t.st.ajax.cursor, w(o + "." + O, j), w("BeforeChange." + O, j)
            }, getAjax: function (i) {
                M && e(document.body).addClass(M), t.updateStatus("loading");
                var n = e.extend({
                    url: i.src, success: function (n, a, s) {
                        var r = {data: n, xhr: s};
                        _("ParseAjax", r), t.appendContent(e(r.data), O), i.finished = !0, L(), t._setFocus(), setTimeout((function () {
                            t.wrap.addClass(f)
            ...
            initImage: function () {
                ...
                var i = 0, n = e.img[0], a = function (s) {
                    z && clearInterval(z), z = setInterval((function () {
                        return n.naturalWidth > 0 ? void t._onImageHasSize(e) : (i > 200 && clearInterval(z), void (3 === ++i ? a(10) : 40 === i ? a(50) : 100 === i && a(500)))
                    }), s)
                };
                a(1)
            }, getImage: function (i, n) {
                var a = 0, s = function () {
                    i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, _("ImageLoadComplete")) : 200 > ++a ? setTimeout(s, 100) : r())
                }, r = function () {
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (i.enabled && t.supportsTransition) {
                    var a, s, r = i.duration, d = function (e) {
                ...
                var o = {width: n.width(), height: (y ? n.innerHeight() : n[0].offsetHeight) - r - s};
                return void 0 === A && (A = void 0 !== document.createElement("p").style.MozTransform), A ? o["-moz-transform"] = o.transform = "translate(" + a.left + "px," + a.top + "px)" : (o.left = a.left, o.top = a.top), o
            }
        }
    });
    var D = "iframe", N = function (e) {
        if (t.currTemplate[D]) {
    ...
    e.magnificPopup.registerModule(D, {
        options: {
            ...
            initIframe: function () {
                t.types.push(D), w("BeforeChange", (function (e, t, i) {
                    t !== i && (t === D ? N() : i === D && N(!0))
                })), w(o + "." + D, (function () {
                    N()
                }))
    ...
    e.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                ...
                return t.direction = !0, !(!i || !i.enabled) && (s += " mfp-gallery", w(c + a, (function () {
                ...
                })), w(d + a, (function (e, n, a, s) {
                    var r = t.items.length;
                    a.counter = r > 1 ? B(i.tCounter, s.index, r) : ""
                })), w("BuildControls" + a, (function () {
                    if (t.items.length > 1 && i.arrows && !t.arrowLeft) {
                        var n = i.arrowMarkup,
                            a = t.arrowLeft = e(n.replace(/%title%/gi, i.tPrev).replace(/%dir%/gi, "left")).addClass(g),
        ...
        options: {
            ...
            initRetina: function () {
                if (window.devicePixelRatio > 1) {
                    ...
                    (i = isNaN(i) ? i() : i) > 1 && (w("ImageHasSize." + Q, (function (e, t) {
            ...
            $.magnificPopup.open({
                ...
                callbacks: {
                    open: function () {
                        ...
                        "" == s && "" == r || $(t).removeClass(s + " " + r + " animated"), "true" == o && Cookies.set(i, "0")
                    }
                }
            }, 0)
    ...
    function n(t) {
        ...
        return t = t.toLowerCase(), p(o, (function (e, a) {
            ...
            return o ? (s = i[l](o), i[d[l].cache] = s[d[l].cache], n = i._rgba = s._rgba, !1) : void 0
    ...
    h.style.cssText = "background-color:rgba(1,1,1,.5)", u.rgba = h.style.backgroundColor.indexOf("rgba") > -1, p(d, (function (e, t) {
        ...
        parse: function (a, r, o, c) {
            if (a === t) return this._rgba = [null, null, null, null], this;
            (a.jquery || a.nodeType) && (a = e(a).css(r), r = t);
            var u = this, h = e.type(a), f = this._rgba = [];
            return r !== t && (a = [a, r, o, c], h = "array"), "string" === h ? this.parse(n(a) || s._default) : "array" === h ? (p(d.rgba.props, (function (e, t) {
                f[t.idx] = i(a[t.idx], t)
            ...
            var n = l(e), a = n._space(), s = d[a], r = 0 === this.alpha() ? l("transparent") : this,
                o = r[s.cache] || s.to(r._rgba), u = o.slice();
            return n = n[s.cache], p(s.props, (function (e, a) {
                var s = a.idx, r = o[s], l = n[s], d = c[a.type] || {};
                null !== l && (null === r ? u[s] = l : (d.mod && (l - r > d.mod / 2 ? r += d.mod : r - l > d.mod / 2 && (r -= d.mod)), u[s] = i((l - r) * t + r, a)))
            })), this[a](u)
        }, blend: function (t) {
        ...
        var t, i, n = e[0] / 255, a = e[1] / 255, s = e[2] / 255, r = e[3], o = Math.max(n, a, s),
            l = Math.min(n, a, s), d = o - l, c = o + l, u = .5 * c;
        return t = l === o ? 0 : n === o ? 60 * (a - s) / d + 360 : a === o ? 60 * (s - n) / d + 120 : 60 * (n - a) / d + 240, i = 0 === d ? 0 : .5 >= u ? d / c : d / (2 - c), [Math.round(t) % 360, i, u, null == r ? 1 : r]
        ...
        var s = a.props, o = a.cache, d = a.to, c = a.from;
        l.fn[n] = function (n) {
            ...
            l.fn[t] || (l.fn[t] = function (a) {
                var s, o = e.type(a), l = "alpha" === t ? this._hsla ? "hsla" : "rgba" : n, d = this[l](), c = d[i.idx];
                return "undefined" === o ? c : ("function" === o && (a = a.call(this, c), o = e.type(a)), null == a && i.empty ? this : ("string" === o && ((s = r.exec(a)) && (a = c + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1))), d[i.idx] = a, this[l](d)))
            })
        }))
    })), l.hook = function (t) {
        var i = t.split(" ");
...
}(jQuery), window.SEMICOLON_linkScrollInit = function (e) {
    if ((e = e.filter(":not(.customjs)")).length < 1) return !0;
    e.off("click").on("click", (function () {
        let e = $(this), t = e.attr("data-scrollto"), i = e.attr("data-speed"), n = e.attr("data-offset"),
            a = e.attr("data-easing"), s = e.attr("data-highlight");
        return !!e.parents(".primary-menu").hasClass("on-click") || (i || (i = 750), n || (n = SEMICOLON.initialize.topScrollOffset()), a || (a = "easeOutQuad"), $("html,body").stop(!0).animate({scrollTop: $(t).offset().top - Number(n)}, Number(i), a, (function () {
            s && ($(t).find(".highlight-me").length > 0 ? ($(t).find(".highlight-me").animate({backgroundColor: s}, 300), setTimeout((function () {
                $(t).find(".highlight-me").animate({backgroundColor: "transparent"}, 300)
            }), 500)) : ($(t).animate({backgroundColor: s}, 300), setTimeout((function () {
    ...
    e(["jquery"], (function (e) {
        return function () {
            function t(t, i) {
                return t || (t = r()), (l = e("#" + t.containerId)).length || i && (l = function (t) {
            ...
            function s(i) {
                ...
                function d() {
                    (f.timeOut > 0 || f.extendedTimeOut > 0) && (g = setTimeout(s, f.extendedTimeOut), _.maxHideTime = parseFloat(f.extendedTimeOut), _.hideEta = (new Date).getTime() + _.maxHideTime)
                }
                ...
                var f = r(), m = i.iconClass || f.iconClass;
                if (void 0 !== i.optionsOverride && (f = e.extend(f, i.optionsOverride), m = i.optionsOverride.iconClass || m), !function (e, t) {
                    ...
                    u++, l = t(f, !0);
                    var g = null, v = e("<div/>"), y = e("<div/>"), b = e("<div/>"), w = e("<div/>"),
                        T = e(f.closeHtml), _ = {intervalId: null, hideEta: null, maxHideTime: null},
                    ...
                    return i.iconClass && v.addClass(f.toastClass).addClass(m), function () {
                        ...
                        easing: f.showEasing,
                        complete: f.onShown
                    }), f.timeOut > 0 && (g = setTimeout(s, f.timeOut), _.maxHideTime = parseFloat(f.timeOut), _.hideEta = (new Date).getTime() + _.maxHideTime, f.progressBar && (_.intervalId = setInterval(p, 10))), f.closeOnHover && v.hover(h, d), !f.onclick && f.tapToDismiss && v.click(s), f.closeButton && T && T.click((function (e) {
    ...
    let t = e, i = t.attr("data-notify-position") || "top-right", n = t.attr("data-notify-type"),
        a = t.attr("data-notify-msg") || "Please set a message!", s = t.attr("data-notify-timeout") || 5e3,
        r = t.attr("data-notify-close");
    return i = "toast-" + i, r = "true" == r, toastr.options.positionClass = i, toastr.options.timeOut = Number(s), toastr.options.closeButton = r, toastr.options.closeHtml = '<button><i class="icon-remove"></i></button>', "warning" == n ? toastr.warning(a) : "error" == n ? toastr.error(a) : "success" == n ? toastr.success(a) : toastr.info(a), !1
...
function sm_format_twitter(e) {
    for (var t = [], i = 0; i < e.length; i++) {
        ...
        t.push('<li><i class="icon-twitter"></i><a href="https://twitter.com/' + n + '" class="twitter-avatar" target="_blank"><img src="' + s + '" alt="' + a + '" title="' + a + '"></a><span>' + r + '</span><small><a href="https://twitter.com/' + n + "/statuses/" + e[i].id_str + '" target="_blank">' + relative_time(e[i].created_at) + "</a></small></li>")
    }
    return t.join("")
}
...
window.SEMICOLON_onePageModule = function (e) {
    if ($onePageMenu = e.filter(":not(.customjs)"), $onePageMenu.length < 1) return !0;
    ...
    if ("undefined" === e && t.length < 1) return !0;
    ...
    return l || (l = Number(r)), d || (d = Number(l)), c || (c = Number(d)), u || (u = Number(c)), h || (h = Number(u)), p || (p = Number(h)), $body.hasClass("device-xxl") ? r = l : $body.hasClass("device-xl") ? r = d : $body.hasClass("device-lg") ? r = c : $body.hasClass("device-md") ? r = u : $body.hasClass("device-sm") ? r = h : $body.hasClass("device-xs") && (r = p), i.offset = r, i.speed = s, i.easing = o, i
}, function (e) {
    ...
    var i = "animsition", n = {
        init: function (a) {
            ...
            var t = this, a = e(this), s = a.data(i).options, r = a.data(n.settings.data.inDuration),
                ...
                d = n.animationCheck.call(t, o, !0, !0), c = n.optionCheck.call(t, s), u = a.data(i).outClass;
            s.loading && n.removeLoading.call(t), u && a.removeClass(u), c ? n.inOverlay.call(t, d, l) : n.inDefault.call(t, d, l)
            ...
            var s = this, r = e(this), o = r.data(i).options, l = t.data(n.settings.data.outClass),
                d = r.data(n.settings.data.outClass), c = t.data(n.settings.data.outDuration),
                u = r.data(n.settings.data.outDuration), h = l || d, p = c || u,
    ...
    function n(i) {
        if (a = t.documentElement, s = t.body, R(), ne = this, le = (i = i || {}).constants || {}, i.easing) for (var n in i.easing) q[n] = i.easing[n];
        me = i.edgeStrategy || "set", re = {
            beforerender: i.beforerender,
            render: i.render,
            keyframe: i.keyframe
        }, (oe = !1 !== i.forceHeight) && (Le = i.scale || 1), de = i.mobileDeceleration || C, ue = !1 !== i.smoothScrolling, he = i.smoothScrollingDuration || S, pe = {targetTop: ne.getScrollTop()}, (Be = (i.mobileCheck || function () {
            return /Android|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent || navigator.vendor || e.opera)
        })()) ? ((se = t.getElementById(i.skrollrBody || x)) && ie(), W(), Ee(a, [y, T], [b])) : Ee(a, [y, w], [b]), ne.refresh(), ye(e, "resize orientationchange", (function () {
            var e = a.clientWidth, t = a.clientHeight;
            (t !== De || e !== Ae) && (De = t, Ae = e, Ne = !0)
        }));
        var r = F();
        return function e() {
            U(), ve = r(e)
    ...
    var a, s, r = {
        ...
        L = /\s*(@?[\w\-\[\]]+)\s*:\s*(.+?)\s*(?:;|$)/gi, j = /^(@?[a-z\-]+)\[(\w+)\]$/, z = /-([a-z0-9_])/g,
        Y = function (e, t) {
            return t.toUpperCase()
        }, A = /[\-+]?[\d]*\.?[\d]+/g, D = /\{\?\}/g, N = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g,
    ...
    n.prototype.refresh = function (e) {
            ...
            if (s && k in r && delete r[k], r.attributes) {
                for (var h = 0, p = r.attributes.length; p > h; h++) {
                    ...
                    if ("data-anchor-target" !== m.name) if ("data-smooth-scrolling" !== m.name) if ("data-edge-strategy" !== m.name) if ("data-emit-events" !== m.name) {
                        ...
                        if (null !== g) {
                            var v = {props: m.value, element: r, eventType: m.name.replace(z, Y)};
                            l.push(v);
                            var y = g[1];
                            ...
                            var w = g[3], T = g[4] || w;
                            w && "start" !== w && "end" !== w ? (v.mode = "relative", v.anchors = [w, T]) : (v.mode = "absolute", "end" === w ? v.isEnd = !0 : v.isPercentage || (v.offset = v.offset * Le))
                        }
                ...
                var _, C, x;
                if (l.length) !s && k in r ? (x = r[k], _ = ae[x].styleAttr, C = ae[x].classAttr) : (x = r[k] = $e++, _ = r.style.cssText, C = Se(r)), ae[x] = {
                    element: r,
                    styleAttr: _,
                    classAttr: C,
                    anchorTarget: o,
        ...
        t = t || {};
        var n = Ie(), a = ne.getScrollTop(), s = t.duration === i ? 1e3 : t.duration;
        return (ce = {
            startTop: a,
            topDiff: e - a,
            targetTop: e,
        ...
        a.style.overflow = s.style.overflow = "", a.style.height = s.style.height = "", se && r.setStyle(se, "transform", "none"), ne = i, se = i, re = i, oe = i, Oe = 0, Le = 1, le = i, de = i, je = "down", ze = -1, Ae = 0, De = 0, Ne = !1, ce = i, ue = i, he = i, pe = i, fe = i, $e = 0, me = i, Be = !1, Qe = 0, ge = i
    };
    var W = function () {
        var n, r, o, d, f, m, g, v, y, b, w;
        ye(a, [c, u, h, p].join(" "), (function (e) {
            ...
            switch (f = a.clientY, m = a.clientX, y = e.timeStamp, I.test(d.tagName) || e.preventDefault(), e.type) {
                case c:
                    n && n.blur(), ne.stopAnimateTo(), n = d, r = g = f, o = m, y;
                    break;
                case u:
        ...
        for (var i = 0, n = ae.length; n > i; i++) {
            var a, s, l = ae[i], d = l.element, c = l.smoothScrolling ? e : t, u = l.keyFrames, h = u.length, p = u[0],
                y = u[u.length - 1], b = c < p.frame, w = c > y.frame, T = b ? p : y, _ = l.emitEvents,
                C = l.lastFrameIndex;
            if (b || w) {
                if (b && -1 === l.edge || w && 1 === l.edge) continue;
                switch (b ? (Ee(d, [m], [v, g]), _ && C > -1 && (Te(d, p.eventType, je), l.lastFrameIndex = -1)) : (Ee(d, [v], [m, g]), _ && h > C && (Te(d, y.eventType, je), l.lastFrameIndex = h)), l.edge = b ? -1 : 1, l.edgeStrategy) {
                    case"reset":
                        te(d);
                        continue;
                    case"ease":
                    ...
                    case"set":
                        var x = T.props;
                        for (a in x) o.call(x, a) && (s = ee(x[a].value), 0 === a.indexOf("@") ? d.setAttribute(a.substr(1), s) : r.setStyle(d, a, s));
                        continue
                }
            ...
            for (var S = 0; h - 1 > S; S++) if (c >= u[S].frame && c <= u[S + 1].frame) {
                ...
                for (a in E.props) if (o.call(E.props, a)) {
                    ...
                    k = E.props[a].easing(k), s = J(E.props[a].value, P.props[a].value, k), s = ee(s), 0 === a.indexOf("@") ? d.setAttribute(a.substr(1), s) : r.setStyle(d, a, s)
                }
                _ && C !== S && (Te(d, "down" === je ? E.eventType : P.eventType, je), l.lastFrameIndex = S);
                break
            }
        }
    }, U = function () {
        ...
        if (fe || ze !== n) {
            fe = !1;
            var s = {curTop: n, lastTop: ze, maxTop: Oe, direction: je = n > ze ? "down" : ze > n ? "up" : je};
            !1 !== (re.beforerender && re.beforerender.call(ne, s)) && (V(n, ne.getScrollTop()), Be && se && r.setStyle(se, "transform", "translate(0, " + -Qe + "px) " + ge), ze = n, re.render && re.render.call(ne, s)), e && e.call(ne, !1)
        }
        Ye = a
    }, G = function (e) {
        for (var t = 0, i = e.keyFrames.length; i > t; t++) {
            for (var n, a, s, r, o = e.keyFrames[t], l = {}; null !== (r = L.exec(o.props));) s = r[1], a = r[2], null !== (n = s.match(j)) ? (s = n[1], n = n[2]) : n = _, a = a.indexOf("!") ? X(a) : [a.slice(1)], l[s] = {
                value: a,
                easing: q[n]
            };
            o.props = l
        ...
        var e = d(se), t = e.getPropertyValue("transform"), i = e.getPropertyValue(Q + "transform");
        t && "none" !== t || i && "none" !== i || (ge = "")
    };
    r.setStyle = function (e, t, i) {
        var n = e.style;
        if ("zIndex" === (t = t.replace(z, Y).replace("-", ""))) isNaN(i) ? n[t] = i : n[t] = "" + (0 | i); else if ("float" === t) n.styleFloat = n.cssFloat = i; else try {
            B && (n[B + t.slice(0, 1).toUpperCase() + t.slice(1)] = i), n[t] = i
        } catch (e) {
        }
    };
    var ne, ae, se, re, oe, le, de, ce, ue, he, pe, fe, me, ge, ve, ye = r.addEvent = function (t, i, n) {
        ...
        Oe = 0, oe && !Be && (s.style.height = ""), function () {
            var e, t, i, n, s, r, o, d, c, u, h, p = a.clientHeight, f = Ce();
            for (d = 0, c = ae.length; c > d; d++) for (t = (e = ae[d]).element, i = e.anchorTarget, s = 0, r = (n = e.keyFrames).length; r > s; s++) u = (o = n[s]).offset, h = f[o.constant] || 0, o.frame = u, o.isPercentage && (u *= p, o.frame = u), "relative" === o.mode && (te(t), o.frame = ne.relativeToAbsolute(i, o.anchors[0], o.anchors[1]) - u, te(t, !0)), o.frame += h, oe && !o.isEnd && o.frame > Oe && (Oe = o.frame);
            for (Oe = l.max(Oe, xe()), d = 0, c = ae.length; c > d; d++) {
                for (s = 0, r = (n = (e = ae[d]).keyFrames).length; r > s; s++) h = f[(o = n[s]).constant] || 0, o.isEnd && (o.frame = Oe - o.offset + h);
                e.keyFrames.sort(Me)
            }
        ...
        if (e.SVGElement && t instanceof e.SVGElement && (t = t[s], s = "baseVal"), a !== i) {
            ...
            r = Pe(r);
            for (var d = 0, c = n.length; c > d; d++) -1 === ke(r).indexOf(ke(n[d])) && (r += " " + n[d]);
            t[s] = Pe(r)
        } else t[s] = n
    }, Pe = function (e) {
        return e.replace(M, "")
    ...
    }, Oe = 0, Le = 1, je = "down", ze = -1, Ye = Ie(), Ae = 0, De = 0, Ne = !1, $e = 0, Be = !1, Qe = 0, Re = [];
    ...
    var t = function (e, t) {
        ...
        this.getCanvas = function () {
            ...
            var n;
            t.scaleColor || t.trackColor ? a.getImageData && a.putImageData ? i ? a.putImageData(i, 0, 0) : (d(), i = a.getImageData(0, 0, t.size * s, t.size * s)) : (this.clear(), d()) : this.clear(), a.lineCap = t.lineCap, n = "function" == typeof t.barColor ? t.barColor(e) : t.barColor, o(n, t.lineWidth, e / 100)
    ...
    return b(e)
})) : "object" == typeof exports ? module.exports = b(require("jquery")) : b(jQuery), window.SEMICOLON_roundedSkillInit = function (e) {
    if ((e = e.filter(":not(.customjs)")).length < 1) return !0;
    e.each((function () {
    ...
    e.each((function () {
        ...
        a = e.find(a), a.html(s), n = Number(n), e.addClass("read-more-wrap").css({
            height: i,
    ...
    let i;
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(e)) return i = e.substring(1).split(""), 3 == i.length && (i = [i[0], i[0], i[1], i[1], i[2], i[2]]), i = "0x" + i.join(""), "rgba(" + [i >> 16 & 255, i >> 8 & 255, 255 & i].join(",") + "," + t + ")";
    console.log("Bad Hex")
    ...
    e.each((function () {
        let e, t, i, n = $(this), a = n.attr("data-shape") || "valley", s = n.attr("data-width") || 100,
            ...
            h = "";
        s < 100 && (s = 100), e = "width: calc( " + Number(s) + "% + 1.5px );", t = "height: " + Number(r) + "px;", i = "fill: " + o + ";", "true" == l && (h = "bottom" == d ? "#" + c + ".shape-divider { bottom: -" + (Number(r) - 1) + "px; } " : "#" + c + ".shape-divider { top: -" + (Number(r) - 1) + "px; } ");
...
}, i = jQuery, i.fn.scwStickySidebar = function (e) {
    function t(e, t) {
        return !0 === e.initialized || !(i("body").width() < e.minWidth) && (function (e, t) {
            e.initialized = !0, 0 === i("#scw-sticky-sidebar-stylesheet-" + e.namespace).length && i("head").append(i('<style id="scw-sticky-sidebar-stylesheet-' + e.namespace + '">.scwStickySidebar:after {content: ""; display: table; clear: both;}</style>')), t.each((function () {
                function t() {
                ...
                var s = {};
                if (s.sidebar = i(this), s.options = e || {}, s.container = i(s.options.containerSelector), 0 == s.container.length && (s.container = s.sidebar.parent()), s.sidebar.parents().css("-webkit-transform", "none"), s.sidebar.css({
                    ...
                    })).remove(), s.stickySidebar = i("<div>").addClass("scwStickySidebar").append(s.sidebar.children()), s.sidebar.append(s.stickySidebar)
                }
                ...
                var o = s.stickySidebar.offset().top, l = s.stickySidebar.outerHeight();
                s.stickySidebar.css("padding-top", 1), s.stickySidebar.css("padding-bottom", 1), o -= s.stickySidebar.offset().top, l = s.stickySidebar.outerHeight() - l - o, 0 == o ? (s.stickySidebar.css("padding-top", 0), s.stickySidebarPaddingTop = 0) : s.stickySidebarPaddingTop = 1, 0 == l ? (s.stickySidebar.css("padding-bottom", 0), s.stickySidebarPaddingBottom = 0) : s.stickySidebarPaddingBottom = 1, s.previousScrollTop = null, s.fixedScrollTop = 0, t(), s.onScroll = function (s) {
                    if (s.stickySidebar.is(":visible")) {
                        if (i("body").width() < s.options.minWidth) return void t();
                        if (s.options.disableOnResponsiveLayouts && s.sidebar.outerWidth("none" == s.sidebar.css("float")) + 50 > s.container.width()) return void t();
                        var r = i(document).scrollTop(), o = "static";
                        if (r >= s.sidebar.offset().top + (s.paddingTop - s.options.additionalMarginTop)) {
                            var l, d = s.paddingTop + e.additionalMarginTop,
                                c = s.paddingBottom + s.marginBottom + e.additionalMarginBottom,
                                u = s.sidebar.offset().top, h = s.sidebar.offset().top + a(s.container),
                                p = 0 + e.additionalMarginTop;
                            l = s.stickySidebar.outerHeight() + d + c < i(window).height() ? p + s.stickySidebar.outerHeight() : i(window).height() - s.marginBottom - s.paddingBottom - e.additionalMarginBottom;
                            var f = u - r + s.paddingTop, m = h - r - s.paddingBottom - s.marginBottom,
                                g = s.stickySidebar.offset().top - r, v = s.previousScrollTop - r;
                            "fixed" == s.stickySidebar.css("position") && "modern" == s.options.sidebarBehavior && (g += v), "stick-to-top" == s.options.sidebarBehavior && (g = e.additionalMarginTop), "stick-to-bottom" == s.options.sidebarBehavior && (g = l - s.stickySidebar.outerHeight()), g = v > 0 ? Math.min(g, p) : Math.max(g, l - s.stickySidebar.outerHeight()), g = Math.max(g, f), g = Math.min(g, m - s.stickySidebar.outerHeight());
                            var y = s.container.height() == s.stickySidebar.outerHeight();
                            o = !y && g == p || !y && g == l - s.stickySidebar.outerHeight() ? "fixed" : r + g - s.sidebar.offset().top - s.paddingTop <= e.additionalMarginTop ? "static" : "absolute"
                        }
                        if ("fixed" == o) {
                            var b = i(document).scrollLeft();
                            s.stickySidebar.css({
                                position: "fixed",
                                width: n(s.stickySidebar) + "px",
                                transform: "translateY(" + g + "px)",
                                left: s.sidebar.offset().left + parseInt(s.sidebar.css("padding-left")) - b + "px",
                                top: "0px"
                            })
                        } else if ("absolute" == o) {
                            var w = {};
                            "absolute" != s.stickySidebar.css("position") && (w.position = "absolute", w.transform = "translateY(" + (r + g - s.sidebar.offset().top - s.stickySidebarPaddingTop - s.stickySidebarPaddingBottom) + "px)", w.top = "0px"), w.width = n(s.stickySidebar) + "px", w.left = "", s.stickySidebar.css(w)
                        } else "static" == o && t();
                ...
                }, s.onScroll(s), i(document).on("scroll." + s.options.namespace, function (e) {
                    return function () {
                        e.onScroll(e)
                    }
                }(s)), i(window).on("resize." + s.options.namespace, function (e) {
                    return function () {
    ...
    return (e = i.extend({
        ...
        t(e, n) || (console.log("TSS: Body width smaller than options.minWidth. Init is delayed."), i(document).on("scroll." + e.namespace, function (e, n) {
            return function (a) {
                t(e, n) && i(this).unbind(a)
            }
        }(e, n)), i(window).on("resize." + e.namespace, function (e, n) {
            return function (a) {
                t(e, n) && i(this).unbind(a)
            }
        }(e, n)))
    ...
    var e = function (t, i) {
        ...
        function a(e, t) {
            ...
            var s, r, o = e.resizeSensor.childNodes[0], l = o.childNodes[0], d = e.resizeSensor.childNodes[1],
                c = (d.childNodes[0], function () {
                    l.style.width = o.offsetWidth + 10 + "px", l.style.height = o.offsetHeight + 10 + "px", o.scrollLeft = o.scrollWidth, o.scrollTop = o.scrollHeight, d.scrollLeft = d.scrollWidth, d.scrollTop = d.scrollHeight, s = e.offsetWidth, r = e.offsetHeight
                });
            c();
            var u = function (e, t, i) {
                e.attachEvent ? e.attachEvent("on" + t, i) : e.addEventListener(t, i)
            }, h = function () {
                e.offsetWidth == s && e.offsetHeight == r || e.resizedAttached && e.resizedAttached.call(), c()
            };
        ...
        addClass: function () {
            ...
            function o(e) {
                ...
                if (t) {
                    ...
                    if (i.indexOf(e) < 0 && i.unshift(e), g(t).is(a)) s.apply(t, i); else for (var n = g(t).parents(), r = 0; r < n.length; r += 1) g(n[r]).is(a) && s.apply(n[r], i)
                }
            }
            ...
            for (var o = n.split(" "), l = 0; l < o.length; l += 1) for (var d = o[l], c = 0; c < this.length; c += 1) {
                ...
                if (!a && u.dom7Listeners ? h = u.dom7Listeners[d] : a && u.dom7LiveListeners && (h = u.dom7LiveListeners[d]), h && h.length) for (var p = h.length - 1; p >= 0; p -= 1) {
                    var f = h[p];
                    s && f.listener === s || s && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === s ? (u.removeEventListener(d, f.proxyListener, r), h.splice(p, 1)) : s || (u.removeEventListener(d, f.proxyListener, r), h.splice(p, 1))
                }
            }
            return this
        }, trigger: function () {
            for (var e = o(), t = arguments.length, i = new Array(t), n = 0; n < t; n++) i[n] = arguments[n];
            for (var a = i[0].split(" "), s = i[1], r = 0; r < a.length; r += 1) for (var l = a[r], d = 0; d < this.length; d += 1) {
                var c = this[d];
                if (e.CustomEvent) {
            ...
            for (var e, t = s(), i = 0; i < arguments.length; i += 1) {
                ...
                } else if (e instanceof p) for (var r = 0; r < e.length; r += 1) this[n].appendChild(e[r]); else this[n].appendChild(e)
            }
            return this
        }, prepend: function (e) {
            var t, i, n = s();
            ...
            for (var t = [], i = 0; i < this.length; i += 1) for (var n = this[i].children, a = 0; a < n.length; a += 1) e && !g(n[a]).is(e) || t.push(n[a]);
            return g(t)
        }, filter: function (e) {
            return g(m(this, e))
        }, remove: function () {
    ...
    function C(e, t) {
        void 0 === t && (t = "x");
        var i, n, a, s = o(), r = s.getComputedStyle(e, null);
    ...
    function S() {
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1) {
            ...
            if (null != i) for (var n = Object.keys(Object(i)), a = 0, s = n.length; a < s; a += 1) {
                var r = n[a], o = Object.getOwnPropertyDescriptor(i, r);
                void 0 !== o && o.enumerable && (x(e[r]) && x(i[r]) ? S(e[r], i[r]) : !x(e[r]) && x(i[r]) ? (e[r] = {}, S(e[r], i[r])) : e[r] = i[r])
            }
        }
        return e
    }
    ...
    function k(e) {
        return void 0 === e && (e = {}), y || (y = function (e) {
            var t = (void 0 === e ? {} : e).userAgent, i = P(), n = o(), a = n.navigator.platform,
                s = t || n.navigator.userAgent, r = {ios: !1, android: !1}, l = n.screen.width, d = n.screen.height,
                c = s.match(/(Android);?[\s\/]+([\d.]+)?/), u = s.match(/(iPad).*OS\s([\d_]+)/),
                h = s.match(/(iPod)(.*OS\s([\d_]+))?/), p = !u && s.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                f = "Win32" === a, m = "MacIntel" === a;
            return !u && m && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((u = s.match(/(Version)\/([\d.]+)/)) || (u = [0, 1, "13_0_0"]), m = !1), c && !f && (r.os = "android", r.android = !0), (u || p || h) && (r.os = "ios", r.ios = !0), r
        }(e)), y
    }
    ...
    var M = {
        ...
        create: function () {
            E(this, {observer: t(t({}, O), {}, {observers: []})})
        },
        on: {
            init: function (e) {
                e.observer.init()
    ...
    function j(e) {
        var t = s(), i = o(), n = this.touchEventsData, a = this.params, r = this.touches;
        if (!this.animating || !a.preventInteractionOnTransition) {
            var l = e;
            l.originalEvent && (l = l.originalEvent);
            var d = g(l.target);
            if (("wrapper" !== a.touchEventsTarget || d.closest(this.wrapperEl).length) && (n.isTouchEvent = "touchstart" === l.type, (n.isTouchEvent || !("which" in l) || 3 !== l.which) && !(!n.isTouchEvent && "button" in l && l.button > 0 || n.isTouched && n.isMoved))) if (!!a.noSwipingClass && "" !== a.noSwipingClass && l.target && l.target.shadowRoot && e.path && e.path[0] && (d = g(e.path[0])), a.noSwiping && d.closest(a.noSwipingSelector ? a.noSwipingSelector : "." + a.noSwipingClass)[0]) this.allowClick = !0; else if (!a.swipeHandler || d.closest(a.swipeHandler)[0]) {
                ...
                var c = r.currentX, u = r.currentY, h = a.edgeSwipeDetection || a.iOSEdgeSwipeDetection,
                ...
                if (!h || !(c <= p || c >= i.screen.width - p)) {
                    if (S(n, {
                        ...
                        isScrolling: void 0,
                        startMoving: void 0
                    }), r.startX = c, r.startY = u, n.touchStartTime = _(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, a.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== l.type) {
                        var f = !0;
                        d.is(n.formElements) && (f = !1), t.activeElement && g(t.activeElement).is(n.formElements) && t.activeElement !== d[0] && t.activeElement.blur();
    ...
    function z(e) {
        var t = s(), i = this.touchEventsData, n = this.params, a = this.touches, r = this.rtlTranslate, o = e;
        if (o.originalEvent && (o = o.originalEvent), i.isTouched) {
            if (!i.isTouchEvent || "touchmove" === o.type) {
                ...
                if (i.allowTouchCallbacks && this.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
                    ...
                    var u, h = a.currentX - a.startX, p = a.currentY - a.startY;
                    if (!(this.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(p, 2)) < this.params.threshold)) if (void 0 === i.isScrolling && (this.isHorizontal() && a.currentY === a.startY || this.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : h * h + p * p >= 25 && (u = 180 * Math.atan2(Math.abs(p), Math.abs(h)) / Math.PI, i.isScrolling = this.isHorizontal() ? u > n.touchAngle : 90 - u > n.touchAngle)), i.isScrolling && this.emit("touchMoveOpposite", o), void 0 === i.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1; else if (i.startMoving) {
    ...
    function Y(e) {
        var t = this, i = t.touchEventsData, n = t.params, a = t.touches, s = t.rtlTranslate, r = t.$wrapperEl,
        ...
        var c, u = _(), h = u - i.touchStartTime;
        if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), h < 300 && u - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), i.lastClickTime = _(), T((function () {
        ...
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, c = n.followFinger ? s ? t.translate : -t.translate : -i.currentTranslate, !n.cssMode) if (n.freeMode) {
            ...
            if (n.freeModeMomentum) {
                ...
                s && (b = -b);
                var w, C, x = !1, S = 20 * Math.abs(t.velocity) * n.freeModeMomentumBounceRatio;
                if (b < t.maxTranslate()) n.freeModeMomentumBounce ? (b + t.maxTranslate() < -S && (b = t.maxTranslate() - S), w = t.maxTranslate(), x = !0, i.allowMomentumBounce = !0) : b = t.maxTranslate(), n.loop && n.centeredSlides && (C = !0); else if (b > t.minTranslate()) n.freeModeMomentumBounce ? (b - t.minTranslate() > S && (b = t.minTranslate() + S), w = t.minTranslate(), x = !0, i.allowMomentumBounce = !0) : b = t.minTranslate(), n.loop && n.centeredSlides && (C = !0); else if (n.freeModeSticky) {
                ...
                if (C && t.once("transitionEnd", (function () {
                    ...
                    if (v = s ? Math.abs((-b - t.translate) / t.velocity) : Math.abs((b - t.translate) / t.velocity), n.freeModeSticky) {
                        var k = Math.abs((s ? -b : b) - t.translate), I = t.slidesSizesGrid[t.activeIndex];
                        v = k < I ? n.speed : k < 2 * I ? 1.5 * n.speed : 2.5 * n.speed
                    }
                } else if (n.freeModeSticky) return void t.slideToClosest();
                n.freeModeMomentumBounce && x ? (t.updateProgress(w), t.setTransition(v), t.setTranslate(b), t.transitionStart(!0, t.swipeDirection), t.animating = !0, r.transitionEnd((function () {
            ...
            for (var M = 0, O = t.slidesSizesGrid[0], L = 0; L < o.length; L += L < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
                var j = L < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
                void 0 !== o[L + j] ? c >= o[L] && c < o[L + j] && (M = L, O = o[L + j] - o[L]) : c >= o[L] && (M = L, O = o[o.length - 1] - o[o.length - 2])
            }
            var z = (c - o[M]) / O, Y = M < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
            if (h > n.longSwipesMs) {
                if (!n.longSwipes) return void t.slideTo(t.activeIndex);
                "next" === t.swipeDirection && (z >= n.longSwipesRatio ? t.slideTo(M + Y) : t.slideTo(M)), "prev" === t.swipeDirection && (z > 1 - n.longSwipesRatio ? t.slideTo(M + Y) : t.slideTo(M))
            } else {
                if (!n.shortSwipes) return void t.slideTo(t.activeIndex);
                !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(M + Y), "prev" === t.swipeDirection && t.slideTo(M)) : d.target === t.navigation.nextEl ? t.slideTo(M + Y) : t.slideTo(M)
            }
        }
    }
    ...
    function A() {
        ...
        if (!t || 0 !== t.offsetWidth) {
            ...
            var i = this.allowSlideNext, n = this.allowSlidePrev, a = this.snapGrid;
    ...
    var Q = {
        ...
        modular: {
            ...
            updateSize: function () {
                ...
                var e = o(), t = this.params, i = this.$wrapperEl, n = this.size, a = this.rtlTranslate,
                    s = this.wrongRTL, r = this.virtual && t.virtual.enabled,
                    l = r ? this.virtual.slides.length : this.slides.length,
                    d = i.children("." + this.params.slideClass), c = r ? this.virtual.slides.length : d.length, u = [],
                    h = [], p = [];
                ...
                var v = this.snapGrid.length, y = this.snapGrid.length, b = t.spaceBetween, w = -m, T = 0, _ = 0;
                if (void 0 !== n) {
                    var C, x;
                    "string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * n), this.virtualSize = -b, a ? d.css({
                        marginLeft: "",
                        marginTop: ""
                    }) : d.css({
                        marginRight: "",
                    ...
                    for (var E, P = t.slidesPerColumn, k = C / P, I = Math.floor(c / t.slidesPerColumn), M = 0; M < c; M += 1) {
                        x = 0;
                        var O = d.eq(M);
                        if (t.slidesPerColumn > 1) {
                            var L = void 0, j = void 0, z = void 0;
                            if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                                var Y = Math.floor(M / (t.slidesPerGroup * t.slidesPerColumn)),
                                    A = M - t.slidesPerColumn * t.slidesPerGroup * Y,
                                    D = 0 === Y ? t.slidesPerGroup : Math.min(Math.ceil((c - Y * P * t.slidesPerGroup) / P), t.slidesPerGroup);
                                L = (j = A - (z = Math.floor(A / D)) * D + Y * t.slidesPerGroup) + z * C / P, O.css({
                            ...
                            } else "column" === t.slidesPerColumnFill ? (z = M - (j = Math.floor(M / P)) * P, (j > I || j === I && z === P - 1) && (z += 1) >= P && (z = 0, j += 1)) : j = M - (z = Math.floor(M / k)) * k;
                            O.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== z && t.spaceBetween && t.spaceBetween + "px")
                        }
                        if ("none" !== O.css("display")) {
                            if ("auto" === t.slidesPerView) {
                                var N = e.getComputedStyle(O[0], null), $ = O[0].style.transform,
                                    B = O[0].style.webkitTransform;
                                if ($ && (O[0].style.transform = "none"), B && (O[0].style.webkitTransform = "none"), t.roundLengths) x = this.isHorizontal() ? O.outerWidth(!0) : O.outerHeight(!0); else if (this.isHorizontal()) {
                                    var Q = parseFloat(N.getPropertyValue("width") || 0),
                                    ...
                                    if (W && "border-box" === W) x = Q + H + q; else {
                                        var V = O[0], U = V.clientWidth;
                                        x = Q + R + F + H + q + (V.offsetWidth - U)
                                    }
                                } else {
                                    var G = parseFloat(N.getPropertyValue("height") || 0),
                                        X = parseFloat(N.getPropertyValue("padding-top") || 0),
                                    ...
                                    if (ee && "border-box" === ee) x = G + Z + J; else {
                                        var te = O[0], ie = te.clientHeight;
                                        x = G + X + K + Z + J + (te.offsetHeight - ie)
                                    }
                                }
                                $ && (O[0].style.transform = $), B && (O[0].style.webkitTransform = B), t.roundLengths && (x = Math.floor(x))
                            } else x = (n - (t.slidesPerView - 1) * b) / t.slidesPerView, t.roundLengths && (x = Math.floor(x)), d[M] && (this.isHorizontal() ? d[M].style.width = x + "px" : d[M].style.height = x + "px");
                            d[M] && (d[M].swiperSlideSize = x), p.push(x), t.centeredSlides ? (w = w + x / 2 + T / 2 + b, 0 === T && 0 !== M && (w = w - n / 2 - b), 0 === M && (w = w - n / 2 - b), Math.abs(w) < .001 && (w = 0), t.roundLengths && (w = Math.floor(w)), _ % t.slidesPerGroup == 0 && u.push(w), h.push(w)) : (t.roundLengths && (w = Math.floor(w)), (_ - Math.min(this.params.slidesPerGroupSkip, _)) % this.params.slidesPerGroup == 0 && u.push(w), h.push(w), w = w + x + b), this.virtualSize += x + b, T = x, _ += 1
                        }
                    }
                    if (this.virtualSize = Math.max(this.virtualSize, n) + g, a && s && ("slide" === t.effect || "coverflow" === t.effect) && i.css({width: this.virtualSize + t.spaceBetween + "px"}), t.setWrapperSize && (this.isHorizontal() ? i.css({width: this.virtualSize + t.spaceBetween + "px"}) : i.css({height: this.virtualSize + t.spaceBetween + "px"})), t.slidesPerColumn > 1 && (this.virtualSize = (x + t.spaceBetween) * C, this.virtualSize = Math.ceil(this.virtualSize / t.slidesPerColumn) - t.spaceBetween, this.isHorizontal() ? i.css({width: this.virtualSize + t.spaceBetween + "px"}) : i.css({height: this.virtualSize + t.spaceBetween + "px"}), t.centeredSlides)) {
                        E = [];
                        for (var ne = 0; ne < u.length; ne += 1) {
                            var ae = u[ne];
                            t.roundLengths && (ae = Math.floor(ae)), u[ne] < this.virtualSize + u[0] && E.push(ae)
                        }
                        u = E
                    }
                    if (!t.centeredSlides) {
                        ...
                        for (var se = 0; se < u.length; se += 1) {
                            var re = u[se];
                            t.roundLengths && (re = Math.floor(re)), u[se] <= this.virtualSize - n && E.push(re)
                        }
                        u = E, Math.floor(this.virtualSize - n) - Math.floor(u[u.length - 1]) > 1 && u.push(this.virtualSize - n)
                    }
                    if (0 === u.length && (u = [0]), 0 !== t.spaceBetween && (this.isHorizontal() ? a ? d.filter(f).css({marginLeft: b + "px"}) : d.filter(f).css({marginRight: b + "px"}) : d.filter(f).css({marginBottom: b + "px"})), t.centeredSlides && t.centeredSlidesBounds) {
                        var oe = 0;
                    ...
                    S(this, {
                        ...
                        slidesGrid: h,
                        slidesSizesGrid: p
                    }), c !== l && this.emit("slidesLengthChange"), u.length !== v && (this.params.watchOverflow && this.checkOverflow(), this.emit("snapGridLengthChange")), h.length !== y && this.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && this.updateSlidesOffset()
                }
                ...
                if (0 !== i.length) {
                    ...
                    for (var s = 0; s < i.length; s += 1) {
                        ...
                        if (t.watchSlidesVisibility || t.centeredSlides && t.autoHeight) {
                            var l = -(a - r.swiperSlideOffset), d = l + this.slidesSizesGrid[s];
                            (l >= 0 && l < this.size - 1 || d > 1 && d <= this.size || l <= 0 && d >= this.size) && (this.visibleSlides.push(r), this.visibleSlidesIndexes.push(s), i.eq(s).addClass(t.slideVisibleClass))
                        }
                        r.progress = n ? -o : o
                    }
                ...
                var i = this.params, n = this.maxTranslate() - this.minTranslate(), a = this.progress,
                    s = this.isBeginning, r = this.isEnd, o = s, l = r;
                0 === n ? (a = 0, s = !0, r = !0) : (s = (a = (e - this.minTranslate()) / n) <= 0, r = a >= 1), S(this, {
                    progress: a,
                    isBeginning: s,
                    isEnd: r
                }), (i.watchSlidesProgress || i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) && this.updateSlidesProgress(e), s && !o && this.emit("reachBeginning toEdge"), r && !l && this.emit("reachEnd toEdge"), (o && !s || l && !r) && this.emit("fromEdge"), this.emit("progress", a)
            }, updateSlidesClasses: function () {
                var e, t = this.slides, i = this.params, n = this.$wrapperEl, a = this.activeIndex, s = this.realIndex,
                ...
                var t, i = this.rtlTranslate ? this.translate : -this.translate, n = this.slidesGrid, a = this.snapGrid,
                    s = this.params, r = this.activeIndex, o = this.realIndex, l = this.snapIndex, d = e;
                if (void 0 === d) {
                ...
                var t = this.params, i = g(e.target).closest("." + t.slideClass)[0], n = !1;
            ...
            getTranslate: function (e) {
                ...
                var i = this.rtlTranslate, n = this.params, a = this.$wrapperEl, s = this.wrapperEl, r = this.progress,
                    o = 0, l = 0;
                this.isHorizontal() ? o = i ? -e : e : l = e, n.roundLengths && (o = Math.floor(o), l = Math.floor(l)), n.cssMode ? s[this.isHorizontal() ? "scrollLeft" : "scrollTop"] = this.isHorizontal() ? -o : -l : n.virtualTranslate || a.transform("translate3d(" + o + "px, " + l + "px, 0px)"), this.previousTranslate = this.translate, this.translate = this.isHorizontal() ? o : l;
                ...
                if (l = n && e > d ? d : n && e < c ? c : e, s.updateProgress(l), r.cssMode) {
            ...
            setTransition: function (e, t) {
                ...
                void 0 === e && (e = !0);
                var i = this.activeIndex, n = this.params, a = this.previousIndex;
                if (!n.cssMode) {
                ...
                void 0 === e && (e = !0);
                var i = this.activeIndex, n = this.previousIndex, a = this.params;
            ...
            slideTo: function (e, t, i, n) {
                ...
                var f = Math.min(s.params.slidesPerGroupSkip, r), m = f + Math.floor((r - f) / s.params.slidesPerGroup);
                m >= l.length && (m = l.length - 1), (u || o.initialSlide || 0) === (c || 0) && i && s.emit("beforeSlideChangeStart");
                var g, v = -l[m];
                if (s.updateProgress(v), o.normalizeSlideIndex) for (var y = 0; y < d.length; y += 1) -Math.floor(100 * v) >= Math.floor(100 * d[y]) && (r = y);
                if (s.initialized && r !== u) {
                    if (!s.allowSlideNext && v < s.translate && v < s.minTranslate()) return !1;
                    if (!s.allowSlidePrev && v > s.translate && v > s.maxTranslate() && (u || 0) !== r) return !1
                }
                if (g = r > u ? "next" : r < u ? "prev" : "reset", h && -v === s.translate || !h && v === s.translate) return s.updateActiveIndex(r), o.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), "slide" !== o.effect && s.setTranslate(v), "reset" !== g && (s.transitionStart(i, g), s.transitionEnd(i, g)), !1;
                if (o.cssMode) {
                    var b, w = s.isHorizontal(), T = -v;
                    return h && (T = p.scrollWidth - p.offsetWidth - T), 0 === t ? p[w ? "scrollLeft" : "scrollTop"] = T : p.scrollTo ? p.scrollTo(((b = {})[w ? "left" : "top"] = T, b.behavior = "smooth", b)) : p[w ? "scrollLeft" : "scrollTop"] = T, !0
                }
                ...
                void 0 === e && (e = this.params.speed), void 0 === t && (t = !0);
                var n = this.params, a = this.animating, s = this.snapGrid, r = this.slidesGrid, o = this.rtlTranslate;
                if (n.loop) {
                    if (a && n.loopPreventsSlide) return !1;
                    this.loopFix(), this._clientLeft = this.$wrapperEl[0].clientLeft
                }
                ...
                var d, c = l(o ? this.translate : -this.translate), u = s.map((function (e) {
                    return l(e)
                })), h = (s[u.indexOf(c)], s[u.indexOf(c) - 1]);
                ...
                var a = this.activeIndex, s = Math.min(this.params.slidesPerGroupSkip, a),
                    r = s + Math.floor((a - s) / this.params.slidesPerGroup),
                    o = this.rtlTranslate ? this.translate : -this.translate;
                if (o >= this.snapGrid[r]) {
                    var l = this.snapGrid[r];
                    o - l > (this.snapGrid[r + 1] - l) * n && (a += this.params.slidesPerGroup)
                } else {
                    var d = this.snapGrid[r - 1];
                    o - d <= (this.snapGrid[r] - d) * n && (a -= this.params.slidesPerGroup)
                }
                ...
                if (i.loop) {
                    ...
                    e = parseInt(g(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? s < t.loopedSlides - a / 2 || s > t.slides.length - t.loopedSlides + a / 2 ? (t.loopFix(), s = n.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), T((function () {
                        t.slideTo(s)
                    }))) : t.slideTo(s) : s > t.slides.length - a ? (t.loopFix(), s = n.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), T((function () {
                        t.slideTo(s)
                    }))) : t.slideTo(s)
                } else t.slideTo(s)
            }
            ...
            loopCreate: function () {
                ...
                for (var u = 0; u < c.length; u += 1) n.append(g(c[u].cloneNode(!0)).addClass(i.slideDuplicateClass));
                for (var h = d.length - 1; h >= 0; h -= 1) n.prepend(g(d[h].cloneNode(!0)).addClass(i.slideDuplicateClass))
            }, loopFix: function () {
                this.emit("beforeLoopFix");
                var e, t = this.activeIndex, i = this.slides, n = this.loopedSlides, a = this.allowSlidePrev,
                    s = this.allowSlideNext, r = this.snapGrid, o = this.rtlTranslate;
                this.allowSlidePrev = !0, this.allowSlideNext = !0;
                var l = -r[t] - this.getTranslate();
                t < n ? (e = i.length - 3 * n + t, e += n, this.slideTo(e, 0, !1, !0) && 0 !== l && this.setTranslate((o ? -this.translate : this.translate) - l)) : t >= i.length - n && (e = -i.length + t + n, e += n, this.slideTo(e, 0, !1, !0) && 0 !== l && this.setTranslate((o ? -this.translate : this.translate) - l)), this.allowSlidePrev = a, this.allowSlideNext = s, this.emit("loopFix")
            ...
            appendSlide: function (e) {
                ...
                var i = this.$wrapperEl, n = this.params, a = this.activeIndex;
            ...
            attachEvents: function () {
                var e = s(), t = this.params, i = this.touchEvents, n = this.el, a = this.wrapperEl, r = this.device,
                    o = this.support;
                this.onTouchStart = j.bind(this), this.onTouchMove = z.bind(this), this.onTouchEnd = Y.bind(this), t.cssMode && (this.onScroll = N.bind(this)), this.onClick = D.bind(this);
                var l = !!t.nested;
                if (!o.touch && o.pointerEvents) n.addEventListener(i.start, this.onTouchStart, !1), e.addEventListener(i.move, this.onTouchMove, l), e.addEventListener(i.end, this.onTouchEnd, !1); else {
                    if (o.touch) {
                        ...
                        n.addEventListener(i.start, this.onTouchStart, d), n.addEventListener(i.move, this.onTouchMove, o.passiveListener ? {
                            passive: !1,
                            capture: l
                        } : l), n.addEventListener(i.end, this.onTouchEnd, d), i.cancel && n.addEventListener(i.cancel, this.onTouchEnd, d), $ || (e.addEventListener("touchstart", B), $ = !0)
                    }
                ...
                (t.preventClicks || t.preventClicksPropagation) && n.addEventListener("click", this.onClick, !0), t.cssMode && a.addEventListener("scroll", this.onScroll), t.updateOnWindowResize ? this.on(r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", A, !0) : this.on("observerUpdate", A, !0)
            }, detachEvents: function () {
                var e = s(), t = this.params, i = this.touchEvents, n = this.el, a = this.wrapperEl, r = this.device,
                    o = this.support, l = !!t.nested;
                if (!o.touch && o.pointerEvents) n.removeEventListener(i.start, this.onTouchStart, !1), e.removeEventListener(i.move, this.onTouchMove, l), e.removeEventListener(i.end, this.onTouchEnd, !1); else {
                    if (o.touch) {
                ...
                (t.preventClicks || t.preventClicksPropagation) && n.removeEventListener("click", this.onClick, !0), t.cssMode && a.removeEventListener("scroll", this.onScroll), this.off(r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", A)
            }
        }, breakpoints: {
            setBreakpoint: function () {
                var e = this.activeIndex, t = this.initialized, i = this.loopedSlides, n = void 0 === i ? 0 : i,
                    a = this.params, s = this.$el, r = a.breakpoints;
                if (r && (!r || 0 !== Object.keys(r).length)) {
                    ...
                    if (o && this.currentBreakpoint !== o) {
                        ...
                        var d = l || this.originalParams, c = a.slidesPerColumn > 1, u = d.slidesPerColumn > 1;
                        c && !u ? (s.removeClass(a.containerModifierClass + "multirow " + a.containerModifierClass + "multirow-column"), this.emitContainerClasses()) : !c && u && (s.addClass(a.containerModifierClass + "multirow"), "column" === d.slidesPerColumnFill && s.addClass(a.containerModifierClass + "multirow-column"), this.emitContainerClasses());
            ...
            addClasses: function () {
                var e = this.classNames, t = this.params, i = this.rtl, n = this.$el, a = this.device, s = [];
                s.push("initialized"), s.push(t.direction), t.freeMode && s.push("free-mode"), t.autoHeight && s.push("autoheight"), i && s.push("rtl"), t.slidesPerColumn > 1 && (s.push("multirow"), "column" === t.slidesPerColumnFill && s.push("multirow-column")), a.android && s.push("android"), a.ios && s.push("ios"), t.cssMode && s.push("css-mode"), s.forEach((function (i) {
            ...
            loadImage: function (e, t, i, n, a, s) {
                ...
                g(e).parent("picture")[0] || e.complete && a ? d() : t ? ((r = new l.Image).onload = d, r.onerror = d, n && (r.sizes = n), i && (r.srcset = i), t && (r.src = t)) : d()
        ...
        function t() {
            ...
            var r = this;
            r.support = P(), r.device = k({userAgent: i.userAgent}), r.browser = I(), r.eventsListeners = {}, r.eventsAnyListeners = [], void 0 === r.modules && (r.modules = {}), Object.keys(r.modules).forEach((function (e) {
                var t = r.modules[e];
                if (t.params) {
            ...
            })), r.params && r.params.onAny && r.onAny(r.params.onAny), r.$ = g;
            var l = g(r.params.el);
            if (e = l[0]) {
                if (l.length > 1) {
                    var d = [];
                ...
                var c, u, h;
                return e.swiper = r, e && e.shadowRoot && e.shadowRoot.querySelector ? (c = g(e.shadowRoot.querySelector("." + r.params.wrapperClass))).children = function (e) {
                    return l.children(e)
        ...
        return a.emitContainerClasses = function () {
            ...
            var e = this.params, t = this.slides, i = this.slidesGrid, n = this.size, a = this.activeIndex, s = 1;
            if (e.centeredSlides) {
    ...
    var q = {
        update: function (e) {
            ...
            for (var k = 0; k < h.length; k += 1) k >= w && k <= T && (void 0 === u || e ? E.push(k) : (k > u && E.push(k), k < c && x.push(k)));
            E.forEach((function (e) {
            ...
            var n = i.renderSlide ? g(i.renderSlide.call(this, e, t)) : g('<div class="' + this.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + "</div>");
        ...
        create: function () {
            E(this, {virtual: t(t({}, q), {}, {slides: this.params.virtual.slides, cache: {}})})
        },
        on: {
        ...
        handle: function (e) {
            var t = o(), i = s(), n = this.rtlTranslate, a = e;
            a.originalEvent && (a = a.originalEvent);
            var r = a.keyCode || a.charCode, l = this.params.keyboard.pageUpDown, d = l && 33 === r, c = l && 34 === r,
            ...
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase()))) {
                if (this.params.keyboard.onlyInViewport && (d || c || u || h || p || f)) {
                    ...
                    var g = t.innerWidth, v = t.innerHeight, y = this.$el.offset();
                    ...
                    for (var b = [[y.left, y.top], [y.left + this.width, y.top], [y.left, y.top + this.height], [y.left + this.width, y.top + this.height]], w = 0; w < b.length; w += 1) {
                        var T = b[w];
                        T[0] >= 0 && T[0] <= g && T[1] >= 0 && T[1] <= v && (m = !0)
                    }
                    if (!m) return
                }
                this.isHorizontal() ? ((d || c || u || h) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), ((c || h) && !n || (d || u) && n) && this.slideNext(), ((d || u) && !n || (c || h) && n) && this.slidePrev()) : ((d || c || p || f) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), (c || f) && this.slideNext(), (d || p) && this.slidePrev()), this.emit("keyPress", r)
            }
        }, enable: function () {
            var e = s();
        ...
        lastScrollTime: _(), lastEventBeforeSnap: void 0, recentWheelEvents: [], event: function () {
            ...
            var a = i.$el;
            if ("container" !== i.params.mousewheel.eventsTarget && (a = g(i.params.mousewheel.eventsTarget)), !i.mouseEntered && !a[0].contains(t.target) && !n.releaseOnEdges) return !0;
            t.originalEvent && (t = t.originalEvent);
            var s = 0, r = i.rtlTranslate ? -1 : 1, o = G.normalize(t);
            ...
            if (n.invert && (s = -s), i.params.freeMode) {
                var l = {time: _(), delta: Math.abs(s), direction: Math.sign(s)}, d = i.mousewheel.lastEventBeforeSnap,
                    c = d && l.time < d.time + 500 && l.delta <= d.delta && l.direction === d.direction;
                if (!c) {
                    i.mousewheel.lastEventBeforeSnap = void 0, i.params.loop && i.loopFix();
                    var u = i.getTranslate() + s * n.sensitivity, h = i.isBeginning, p = i.isEnd;
                    if (u >= i.minTranslate() && (u = i.minTranslate()), u <= i.maxTranslate() && (u = i.maxTranslate()), i.setTransition(0), i.setTranslate(u), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!h && i.isBeginning || !p && i.isEnd) && i.updateSlidesClasses(), i.params.freeModeSticky) {
                        ...
                        if (f.push(l), m && (l.delta > m.delta || l.direction !== m.direction)) f.splice(0); else if (f.length >= 15 && l.time - v.time < 500 && v.delta - l.delta >= 1 && l.delta <= 6) {
                            var y = s > 0 ? .8 : .2;
                            i.mousewheel.lastEventBeforeSnap = l, f.splice(0), i.mousewheel.timeout = T((function () {
                                i.slideToClosest(i.params.speed, !0, void 0, y)
                            }), 0)
                        }
                        i.mousewheel.timeout || (i.mousewheel.timeout = T((function () {
                ...
                var b = {time: _(), delta: Math.abs(s), direction: Math.sign(s), raw: e},
                    w = i.mousewheel.recentWheelEvents;
                w.length >= 2 && w.shift();
                var C = w.length ? w[w.length - 1] : void 0;
                if (w.push(b), C ? (b.direction !== C.direction || b.delta > C.delta || b.time > C.time + 150) && i.mousewheel.animateSlider(b) : i.mousewheel.animateSlider(b), i.mousewheel.releaseScroll(b)) return !0
            }
            ...
            var t = this.$el;
            return "container" !== this.params.mousewheel.eventsTarget && (t = g(this.params.mousewheel.eventsTarget)), t.on("mouseenter", this.mousewheel.handleMouseEnter), t.on("mouseleave", this.mousewheel.handleMouseLeave), t.on(e, this.mousewheel.handle), this.mousewheel.enabled = !0, !0
        }, disable: function () {
            var e = G.event();
            ...
            if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                ...
                if (this.params.loop ? ((i = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > n - 1 - 2 * this.loopedSlides && (i -= n - 2 * this.loopedSlides), i > s - 1 && (i -= s), i < 0 && "bullets" !== this.params.paginationType && (i = s + i)) : i = void 0 !== this.snapIndex ? this.snapIndex : this.activeIndex || 0, "bullets" === t.type && this.pagination.bullets && this.pagination.bullets.length > 0) {
                    ...
                    if (t.dynamicBullets && (this.pagination.bulletSize = d.eq(0)[this.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(this.isHorizontal() ? "width" : "height", this.pagination.bulletSize * (t.dynamicMainBullets + 4) + "px"), t.dynamicMainBullets > 1 && void 0 !== this.previousIndex && (this.pagination.dynamicBulletIndex += i - this.previousIndex, this.pagination.dynamicBulletIndex > t.dynamicMainBullets - 1 ? this.pagination.dynamicBulletIndex = t.dynamicMainBullets - 1 : this.pagination.dynamicBulletIndex < 0 && (this.pagination.dynamicBulletIndex = 0)), r = i - this.pagination.dynamicBulletIndex, l = ((o = r + (Math.min(d.length, t.dynamicMainBullets) - 1)) + r) / 2), d.removeClass(t.bulletActiveClass + " " + t.bulletActiveClass + "-next " + t.bulletActiveClass + "-next-next " + t.bulletActiveClass + "-prev " + t.bulletActiveClass + "-prev-prev " + t.bulletActiveClass + "-main"), a.length > 1) d.each((function (e) {
                        var n = g(e), a = n.index();
                        a === i && n.addClass(t.bulletActiveClass), t.dynamicBullets && (a >= r && a <= o && n.addClass(t.bulletActiveClass + "-main"), a === r && n.prev().addClass(t.bulletActiveClass + "-prev").prev().addClass(t.bulletActiveClass + "-prev-prev"), a === o && n.next().addClass(t.bulletActiveClass + "-next").next().addClass(t.bulletActiveClass + "-next-next"))
                    })); else {
                        ...
                        if (c.addClass(t.bulletActiveClass), t.dynamicBullets) {
                            ...
                            } else h.prev().addClass(t.bulletActiveClass + "-prev").prev().addClass(t.bulletActiveClass + "-prev-prev"), p.next().addClass(t.bulletActiveClass + "-next").next().addClass(t.bulletActiveClass + "-next-next"); else h.prev().addClass(t.bulletActiveClass + "-prev").prev().addClass(t.bulletActiveClass + "-prev-prev"), p.next().addClass(t.bulletActiveClass + "-next").next().addClass(t.bulletActiveClass + "-next-next")
                        }
                    }
                    if (t.dynamicBullets) {
                ...
                if ("fraction" === t.type && (a.find("." + t.currentClass).text(t.formatFractionCurrent(i + 1)), a.find("." + t.totalClass).text(t.formatFractionTotal(s))), "progressbar" === t.type) {
                    ...
                    var T = (i + 1) / s, _ = 1, C = 1;
                    "horizontal" === w ? _ = T : C = T, a.find("." + t.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + _ + ") scaleY(" + C + ")").transition(this.params.speed)
                }
                "custom" === t.type && t.renderCustom ? (a.html(t.renderCustom(this, i + 1, s)), this.emit("paginationRender", a[0])) : this.emit("paginationUpdate", a[0]), a[this.params.watchOverflow && this.isLocked ? "addClass" : "removeClass"](t.lockClass)
            }
        }, render: function () {
        ...
        setTranslate: function () {
            if (this.params.scrollbar.el && this.scrollbar.el) {
                ...
                t ? (d = -d) > 0 ? (l = n - d, d = 0) : -d + n > a && (l = a + d) : d < 0 ? (l = n + d, d = 0) : d + n > a && (l = a - d), this.isHorizontal() ? (s.transform("translate3d(" + d + "px, 0, 0)"), s[0].style.width = l + "px") : (s.transform("translate3d(0px, " + d + "px, 0)"), s[0].style.height = l + "px"), o.hide && (clearTimeout(this.scrollbar.timeout), r[0].style.opacity = 1, this.scrollbar.timeout = setTimeout((function () {
            ...
            if (this.params.scrollbar.el && this.scrollbar.el) {
                ...
                var n, a = this.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight, s = this.size / this.virtualSize,
                    r = s * (a / this.size);
                n = "auto" === this.params.scrollbar.dragSize ? a * s : parseInt(this.params.scrollbar.dragSize, 10), this.isHorizontal() ? t[0].style.width = n + "px" : t[0].style.height = n + "px", i[0].style.display = s >= 1 ? "none" : "", this.params.scrollbar.hide && (i[0].style.opacity = 0), S(e, {
                    trackSize: a,
                    divider: s,
                    moveDivider: r,
                    dragSize: n
            ...
            var t, i = this.scrollbar, n = this.rtlTranslate, a = i.$el, s = i.dragSize, r = i.trackSize,
                o = i.dragStartPos;
            t = (i.getPointerPosition(e) - a.offset()[this.isHorizontal() ? "left" : "top"] - (null !== o ? o : s / 2)) / (r - s), t = Math.max(Math.min(t, 1), 0), n && (t = 1 - t);
            var l = this.minTranslate() + (this.maxTranslate() - this.minTranslate()) * t;
            this.updateProgress(l), this.setTranslate(l), this.updateActiveIndex(), this.updateSlidesClasses()
        }, onDragStart: function (e) {
            var t = this.params.scrollbar, i = this.scrollbar, n = this.$wrapperEl, a = i.$el, s = i.$dragEl;
            this.scrollbar.isTouched = !0, this.scrollbar.dragStartPos = e.target === s[0] || e.target === s ? i.getPointerPosition(e) - e.target.getBoundingClientRect()[this.isHorizontal() ? "left" : "top"] : null, e.preventDefault(), e.stopPropagation(), n.transition(100), s.transition(100), i.setDragPosition(e), clearTimeout(this.scrollbar.dragTimeout), a.transition(0), t.hide && a.css("opacity", 1), this.params.cssMode && this.$wrapperEl.css("scroll-snap-type", "none"), this.emit("scrollbarDragStart", e)
            ...
            var t = this.params.scrollbar, i = this.scrollbar, n = this.$wrapperEl, a = i.$el;
            this.scrollbar.isTouched && (this.scrollbar.isTouched = !1, this.params.cssMode && (this.$wrapperEl.css("scroll-snap-type", ""), n.transition("")), t.hide && (clearTimeout(this.scrollbar.dragTimeout), this.scrollbar.dragTimeout = T((function () {
                a.css("opacity", 0), a.transition(400)
            }), 1e3)), this.emit("scrollbarDragEnd", e), t.snapOnRelease && this.slideToClosest())
        }, enableDraggable: function () {
            if (this.params.scrollbar.el) {
                var e = s(), t = this.scrollbar, i = this.touchEventsTouch, n = this.touchEventsDesktop,
                ...
                r.touch ? (o.addEventListener(i.start, this.scrollbar.onDragStart, l), o.addEventListener(i.move, this.scrollbar.onDragMove, l), o.addEventListener(i.end, this.scrollbar.onDragEnd, d)) : (o.addEventListener(n.start, this.scrollbar.onDragStart, l), e.addEventListener(n.move, this.scrollbar.onDragMove, l), e.addEventListener(n.end, this.scrollbar.onDragEnd, d))
            }
            ...
            if (this.params.scrollbar.el) {
                var e = s(), t = this.scrollbar, i = this.touchEventsTouch, n = this.touchEventsDesktop,
                    ...
                    l = !(!r.passiveListener || !a.passiveListeners) && {passive: !1, capture: !1},
                    d = !(!r.passiveListener || !a.passiveListeners) && {passive: !0, capture: !1};
                r.touch ? (o.removeEventListener(i.start, this.scrollbar.onDragStart, l), o.removeEventListener(i.move, this.scrollbar.onDragMove, l), o.removeEventListener(i.end, this.scrollbar.onDragEnd, d)) : (o.removeEventListener(n.start, this.scrollbar.onDragStart, l), e.removeEventListener(n.move, this.scrollbar.onDragMove, l), e.removeEventListener(n.end, this.scrollbar.onDragEnd, d))
            }
        }, init: function () {
            if (this.params.scrollbar.el) {
                var e = this.scrollbar, t = this.$el, i = this.params.scrollbar, n = g(i.el);
                ...
                0 === a.length && (a = g('<div class="' + this.params.scrollbar.dragClass + '"></div>'), n.append(a)), S(e, {
                    $el: n,
                    el: n[0],
                    $dragEl: a,
                    dragEl: a[0]
        ...
        setTransform: function (e, t) {
            var i = this.rtl, n = g(e), a = i ? -1 : 1, s = n.attr("data-swiper-parallax") || "0",
            ...
            if (r || o ? (r = r || "0", o = o || "0") : this.isHorizontal() ? (r = s, o = "0") : (o = s, r = "0"), r = r.indexOf("%") >= 0 ? parseInt(r, 10) * t * a + "%" : r * t * a + "px", o = o.indexOf("%") >= 0 ? parseInt(o, 10) * t + "%" : o * t + "px", null != d) {
            ...
            t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((function (t) {
                ...
                var s = t.progress;
                e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (s += Math.ceil(i / 2) - n * (a.length - 1)), s = Math.min(Math.max(s, -1), 1), g(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((function (t) {
                    e.parallax.setTransform(t, s)
                }))
            }))
        }, setTransition: function (e) {
            void 0 === e && (e = this.params.speed), this.$el.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((function (t) {
                var i = g(t), n = parseInt(i.attr("data-swiper-parallax-duration"), 10) || e;
        ...
        getDistanceBetweenTouches: function (e) {
            ...
            var t = this.support, i = this.params.zoom, n = this.zoom, a = n.gesture;
            if (n.fakeGestureTouched = !1, n.fakeGestureMoved = !1, !t.gestures) {
                if ("touchstart" !== e.type || "touchstart" === e.type && e.targetTouches.length < 2) return;
                n.fakeGestureTouched = !0, a.scaleStart = ee.getDistanceBetweenTouches(e)
            }
            a.$slideEl && a.$slideEl.length || (a.$slideEl = g(e.target).closest("." + this.params.slideClass), 0 === a.$slideEl.length && (a.$slideEl = this.slides.eq(this.activeIndex)), a.$imageEl = a.$slideEl.find("img, svg, canvas, picture, .swiper-zoom-target"), a.$imageWrapEl = a.$imageEl.parent("." + i.containerClass), a.maxRatio = a.$imageWrapEl.attr("data-swiper-zoom") || i.maxRatio, 0 !== a.$imageWrapEl.length) ? (a.$imageEl && a.$imageEl.transition(0), this.zoom.isScaling = !0) : a.$imageEl = void 0
        }, onGestureChange: function (e) {
            var t = this.support, i = this.params.zoom, n = this.zoom, a = n.gesture;
            if (!t.gestures) {
                if ("touchmove" !== e.type || "touchmove" === e.type && e.targetTouches.length < 2) return;
                n.fakeGestureMoved = !0, a.scaleMove = ee.getDistanceBetweenTouches(e)
            }
            ...
            var t = this.device, i = this.support, n = this.params.zoom, a = this.zoom, s = a.gesture;
            if (!i.gestures) {
                if (!a.fakeGestureTouched || !a.fakeGestureMoved) return;
                if ("touchend" !== e.type || "touchend" === e.type && e.changedTouches.length < 2 && !t.android) return;
                a.fakeGestureTouched = !1, a.fakeGestureMoved = !1
            }
            s.$imageEl && 0 !== s.$imageEl.length && (a.scale = Math.max(Math.min(a.scale, s.maxRatio), n.minRatio), s.$imageEl.transition(this.params.speed).transform("translate3d(0,0,0) scale(" + a.scale + ")"), a.currentScale = a.scale, a.isScaling = !1, 1 === a.scale && (s.$slideEl = void 0))
            ...
            var t, i, n, a, s, r, o, l, d, c, u, h, p, f, m, g, v = this.zoom, y = this.params.zoom, b = v.gesture,
                w = v.image;
            ...
            if (!t.enabled) {
                ...
                var i = !("touchstart" !== this.touchEvents.start || !e.passiveListener || !this.params.passiveListeners) && {
                    passive: !0,
                    capture: !1
                }, n = !e.passiveListener || {passive: !1, capture: !0}, a = "." + this.params.slideClass;
            ...
            if (e.enabled) {
                ...
                var i = !("touchstart" !== this.touchEvents.start || !t.passiveListener || !this.params.passiveListeners) && {
                    passive: !0,
                    capture: !1
                }, n = !t.passiveListener || {passive: !1, capture: !0}, a = "." + this.params.slideClass;
        ...
        loadInSlide: function (e, t) {
            ...
            if (void 0 !== e && 0 !== i.slides.length) {
                ...
                !a.hasClass(n.elementClass) || a.hasClass(n.loadedClass) || a.hasClass(n.loadingClass) || s.push(a[0]), 0 !== s.length && s.each((function (e) {
                    ...
                    i.loadImage(s[0], o || r, l, d, !1, (function () {
                        if (null != i && i && (!i || i.params) && !i.destroyed) {
                            if (r ? (s.css("background-image", 'url("' + r + '")'), s.removeAttr("data-background")) : (l && (s.attr("srcset", l), s.removeAttr("data-srcset")), d && (s.attr("sizes", d), s.removeAttr("data-sizes")), c.length && c.children("source").each((function (e) {
                                var t = g(e);
            ...
            function d(e) {
                return s ? g(e).attr("data-swiper-slide-index") : g(e).index()
            }
            ...
            if (r.loadPrevNext) if (o > 1 || r.loadPrevNextAmount && r.loadPrevNextAmount > 1) {
                for (var u = r.loadPrevNextAmount, h = o, p = Math.min(a + h + Math.max(u, h), n.length), f = Math.max(a - Math.max(h, u), 0), m = a + o; m < p; m += 1) l(m) && e.lazy.loadInSlide(m);
        ...
        LinearSpline: function (e, t) {
            ...
            function r(t) {
                t.setTransition(e, n), 0 !== e && (t.transitionStart(), t.params.autoHeight && T((function () {
                    t.updateAutoHeight()
        ...
        getRandomNumber: function (e) {
            ...
            var n, a, s, r = e.$wrapperEl, o = r.attr("id") || "swiper-wrapper-" + e.a11y.getRandomNumber(16);
            e.a11y.addElId(r, o), n = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite", e.a11y.addElLive(r, n), t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription(g(e.slides), t.itemRoleDescriptionMessage), e.a11y.addElRole(g(e.slides), "group"), e.slides.each((function (t) {
                var i = g(t);
        ...
        init: function () {
            ...
            if (this.history.initialized && this.params.history.enabled) {
                ...
                var a = this.slides.eq(t), s = ae.slugify(a.attr("data-history"));
            ...
            if (t) for (var n = 0, a = this.slides.length; n < a; n += 1) {
                ...
                if (ae.slugify(s.attr("data-history")) === t && !s.hasClass(this.params.slideDuplicateClass)) {
                    var r = s.index();
                    this.slideTo(r, e, i)
                }
        ...
        setTranslate: function () {
            var e, t = this.$el, i = this.$wrapperEl, n = this.slides, a = this.width, s = this.height,
                r = this.rtlTranslate, o = this.size, l = this.browser, d = this.params.cubeEffect,
                c = this.isHorizontal(), u = this.virtual && this.params.virtual.enabled, h = 0;
            d.shadow && (c ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = g('<div class="swiper-cube-shadow"></div>'), i.append(e)), e.css({height: a + "px"})) : 0 === (e = t.find(".swiper-cube-shadow")).length && (e = g('<div class="swiper-cube-shadow"></div>'), t.append(e)));
            for (var p = 0; p < n.length; p += 1) {
                var f = n.eq(p), m = p;
                u && (m = parseInt(f.attr("data-swiper-slide-index"), 10));
                var v = 90 * m, y = Math.floor(v / 360);
                r && (v = -v, y = Math.floor(-v / 360));
                var b = Math.max(Math.min(f[0].progress, 1), -1), w = 0, T = 0, _ = 0;
                m % 4 == 0 ? (w = 4 * -y * o, _ = 0) : (m - 1) % 4 == 0 ? (w = 0, _ = 4 * -y * o) : (m - 2) % 4 == 0 ? (w = o + 4 * y * o, _ = o) : (m - 3) % 4 == 0 && (w = -o, _ = 3 * o + 4 * o * y), r && (w = -w), c || (T = w, w = 0);
                var C = "rotateX(" + (c ? 0 : -v) + "deg) rotateY(" + (c ? v : 0) + "deg) translate3d(" + w + "px, " + T + "px, " + _ + "px)";
                if (b <= 1 && b > -1 && (h = 90 * m + 90 * b, r && (h = 90 * -m - 90 * b)), f.transform(C), d.slideShadows) {
                    ...
                    0 === x.length && (x = g('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'), f.append(x)), 0 === S.length && (S = g('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'), f.append(S)), x.length && (x[0].style.opacity = Math.max(-b, 0)), S.length && (S[0].style.opacity = Math.max(b, 0))
                }
            }
            if (i.css({
                ...
                var E = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                    ...
                    k = d.shadowScale, I = d.shadowScale / P, M = d.shadowOffset;
                e.transform("scale3d(" + k + ", 1, " + I + ") translate3d(0px, " + (s / 2 + M) + "px, " + -s / 2 / I + "px) rotateX(-90deg)")
            }
        ...
        setTranslate: function () {
            for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                ...
                if (this.isHorizontal() ? t && (s = -s) : (l = o, o = 0, r = -s, s = 0), n[0].style.zIndex = -Math.abs(Math.round(a)) + e.length, this.params.flipEffect.slideShadows) {
                    ...
                    0 === d.length && (d = g('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), n.append(d)), 0 === c.length && (c = g('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), n.append(c)), d.length && (d[0].style.opacity = Math.max(-a, 0)), c.length && (c[0].style.opacity = Math.max(a, 0))
                }
        ...
        setTranslate: function () {
            for (var e = this.width, t = this.height, i = this.slides, n = this.slidesSizesGrid, a = this.params.coverflowEffect, s = this.isHorizontal(), r = this.translate, o = s ? e / 2 - r : t / 2 - r, l = s ? a.rotate : -a.rotate, d = a.depth, c = 0, u = i.length; c < u; c += 1) {
                var h = i.eq(c), p = n[c], f = (o - h[0].swiperSlideOffset - p / 2) / p * a.modifier, m = s ? l * f : 0,
                    v = s ? 0 : l * f, y = -d * Math.abs(f), b = a.stretch;
                "string" == typeof b && -1 !== b.indexOf("%") && (b = parseFloat(a.stretch) / 100 * p);
                var w = s ? 0 : b * f, T = s ? b * f : 0, _ = 1 - (1 - a.scale) * Math.abs(f);
                Math.abs(T) < .001 && (T = 0), Math.abs(w) < .001 && (w = 0), Math.abs(y) < .001 && (y = 0), Math.abs(m) < .001 && (m = 0), Math.abs(v) < .001 && (v = 0), Math.abs(_) < .001 && (_ = 0);
                var C = "translate3d(" + T + "px," + w + "px," + y + "px)  rotateX(" + v + "deg) rotateY(" + m + "deg) scale(" + _ + ")";
                if (h.transform(C), h[0].style.zIndex = 1 - Math.abs(Math.round(f)), a.slideShadows) {
                    ...
                    0 === x.length && (x = g('<div class="swiper-slide-shadow-' + (s ? "left" : "top") + '"></div>'), h.append(x)), 0 === S.length && (S = g('<div class="swiper-slide-shadow-' + (s ? "right" : "bottom") + '"></div>'), h.append(S)), x.length && (x[0].style.opacity = f > 0 ? f : 0), S.length && (S[0].style.opacity = -f > 0 ? -f : 0)
                }
            }
        }, setTransition: function (e) {
        ...
        init: function () {
            ...
            if (e) {
                ...
                if (!(i && g(i).hasClass(this.params.thumbs.slideThumbActiveClass) || null == t)) {
                    ...
                    if (n = e.params.loop ? parseInt(g(e.clickedSlide).attr("data-swiper-slide-index"), 10) : t, this.params.loop) {
                        ...
                        var s = this.slides.eq(a).prevAll('[data-swiper-slide-index="' + n + '"]').eq(0).index(),
            ...
            if (t) {
                var i = "auto" === t.params.slidesPerView ? t.slidesPerViewDynamic() : t.params.slidesPerView,
                    n = this.params.thumbs.autoScrollOffset, a = n && !t.params.loop;
                if (this.realIndex !== t.realIndex || a) {
                    var s, r, o = t.activeIndex;
                    if (t.params.loop) {
                        t.slides.eq(o).hasClass(t.params.slideDuplicateClass) && (t.loopFix(), t._clientLeft = t.$wrapperEl[0].clientLeft, o = t.activeIndex);
                        var l = t.slides.eq(o).prevAll('[data-swiper-slide-index="' + this.realIndex + '"]').eq(0).index(),
                            d = t.slides.eq(o).nextAll('[data-swiper-slide-index="' + this.realIndex + '"]').eq(0).index();
                        s = void 0 === l ? d : void 0 === d ? l : d - o == o - l ? o : d - o < o - l ? d : l, r = this.activeIndex > this.previousIndex ? "next" : "prev"
                    } else r = (s = this.realIndex) > this.previousIndex ? "next" : "prev";
                    a && (s += "next" === r ? n : -1 * n), t.visibleSlidesIndexes && t.visibleSlidesIndexes.indexOf(s) < 0 && (t.params.centeredSlides ? s = s > o ? s - Math.floor(i / 2) + 1 : s + Math.floor(i / 2) - 1 : s > o && (s = s - i + 1), t.slideTo(s, e ? 0 : void 0))
                }
                var c = 1, u = this.params.thumbs.slideThumbActiveClass;
                if (this.params.slidesPerView > 1 && !this.params.centeredSlides && (c = this.params.slidesPerView), this.params.thumbs.multipleActiveThumbs || (c = 1), c = Math.floor(c), t.slides.removeClass(u), t.params.loop || t.params.virtual && t.params.virtual.enabled) for (var h = 0; h < c; h += 1) t.$wrapperEl.children('[data-swiper-slide-index="' + (this.realIndex + h) + '"]').addClass(u); else for (var p = 0; p < c; p += 1) t.slides.eq(this.realIndex + p).addClass(u)
            }
        }
    }, he = [W, U, {
        name: "mousewheel",
        ...
        on: {
            init: function (e) {
                ...
                var i, n = e.navigation, a = n.$nextEl, s = n.$prevEl;
                !e.params.navigation.hideOnClick || g(t.target).is(s) || g(t.target).is(a) || (a ? i = a.hasClass(e.params.navigation.hiddenClass) : s && (i = s.hasClass(e.params.navigation.hiddenClass)), !0 === i ? e.emit("navigationShow") : e.emit("navigationHide"), a && a.toggleClass(e.params.navigation.hiddenClass), s && s.toggleClass(e.params.navigation.hiddenClass))
            }
        }
    }, {
        name: "pagination",
        ...
        create: function () {
            E(this, {scrollbar: t({isTouched: !1, timeout: null, dragTimeout: null}, Z)})
        },
        on: {
            init: function (e) {
        ...
        create: function () {
            E(this, {lazy: t({initialImageLoaded: !1}, te)})
        },
        on: {
            beforeInit: function (e) {
        ...
        name: "controller", params: {controller: {control: void 0, inverse: !1, by: "slide"}}, create: function () {
            E(this, {controller: t({control: this.params.controller.control}, ie)})
        }, on: {
            update: function (e) {
        ...
        create: function () {
            E(this, {a11y: t(t({}, ne), {}, {liveRegion: g('<span class="' + this.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>')})})
        },
        on: {
        ...
        create: function () {
            E(this, {hashNavigation: t({initialized: !1}, se)})
        },
        on: {
            init: function (e) {
        ...
        create: function () {
            E(this, {thumbs: t({swiper: null, initialized: !1}, ue)})
        },
        on: {
            beforeInit: function (e) {
    ...
    e.each((function () {
        ...
        s = s ? Number(s) : 999999999, r = "true" == r, c = "true" == c, d = "false" != d, p = "false" != p, o = "random" === o ? Math.floor(Math.random() * i.find(".swiper-slide:not(.swiper-slide-duplicate)").length) : Number(o) - 1, i.find(".swiper-pagination").length > 0 ? (e = i.find(".swiper-pagination").get(0), t = !0) : (e = "", t = !1);
    ...
    e.cleanData = function (t) {
        ...
        var a, s, r, o = {}, l = t.split(".")[0], d = l + "-" + (t = t.split(".")[1]);
        ...
        _processTabs: function () {
            ...
            this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", (function (t) {
                ...
                var a, s, r, o = e(n).uniqueId().attr("id"), l = e(n).closest("li"), d = l.attr("aria-controls");
                t._isLocal(n) ? (r = (a = n.hash).substring(1), s = t.element.find(t._sanitizeSelector(a))) : (a = "#" + (r = l.attr("aria-controls") || e({}).uniqueId()[0].id), (s = t.element.find(a)).length || (s = t._createPanel(r)).insertAfter(t.panels[i - 1] || t.tablist), s.attr("aria-live", "polite")), s.length && (t.panels = t.panels.add(s)), d && l.data("ui-tabs-aria-controls", d), l.attr({
                    "aria-controls": r,
                    "aria-labelledby": o
        ...
        _eventHandler: function (t) {
            var i = this.options, n = this.active, a = e(t.currentTarget).closest("li"), s = a[0] === n[0],
                ...
                d = {oldTab: n, oldPanel: l, newTab: r ? e() : a, newPanel: o};
            t.preventDefault(), a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || s && !i.collapsible || !1 === this._trigger("beforeActivate", t, d) || (i.active = !r && this.tabs.index(a), this.active = s ? e() : a, this.xhr && this.xhr.abort(), l.length || o.length || e.error("jQuery UI Tabs: Mismatching fragment identifier."), o.length && this.load(this.tabs.index(a), t), this._toggle(t, d))
        },
    ...
    e.effects = {effect: {}}, function (e, t) {
        ...
        function n(i) {
            ...
            return i = i.toLowerCase(), p(o, (function (e, s) {
                var r, o = s.re.exec(i), l = o && s.parse(o), c = s.space || "rgba";
                return l ? (r = n[c](l), n[d[c].cache] = r[d[c].cache], a = n._rgba = r._rgba, !1) : t
        ...
        h.style.cssText = "background-color:rgba(1,1,1,.5)", u.rgba = h.style.backgroundColor.indexOf("rgba") > -1, p(d, (function (e, t) {
            ...
            l.fn[n] = function (n) {
                ...
                l.fn[t] || (l.fn[t] = function (a) {
                    var s, o = e.type(a), l = "alpha" === t ? this._hsla ? "hsla" : "rgba" : n, d = this[l](),
                        c = d[i.idx];
                    return "undefined" === o ? c : ("function" === o && (a = a.call(this, c), o = e.type(a)), null == a && i.empty ? this : ("string" === o && ((s = r.exec(a)) && (a = c + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1))), d[i.idx] = a, this[l](d)))
                })
            }))
        ...
        e.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], (function (t, i) {
            ...
            return this.queue((function () {
                var s, r = e(this), o = r.attr("class") || "", d = l.children ? r.find("*").addBack() : r;
                d = d.map((function () {
                ...
                })), r.attr("class", o), d = d.map((function () {
        ...
        e.expr && e.expr.filters && e.expr.filters.animated && (e.expr.filters.animated = function (t) {
            ...
            effect: function () {
                function i(t) {
                    ...
                    var o = e(this);
                    n.mode = u.shift(), !1 === e.uiBackCompat || r ? "none" === n.mode ? (o[c](), i()) : a.call(o[0], n, (function () {
                ...
                var n = t.apply(this, arguments), a = e.effects.effect[n.effect], r = a.mode, o = n.queue,
                    l = o || "fx", d = n.complete, c = n.mode, u = [], h = function (t) {
                        var i = e(this), n = e.effects.mode(i, c) || r;
                ...
                var n = e(this), a = e(t.to), s = "fixed" === a.css("position"), r = e("body"),
                    o = s ? r.scrollTop() : 0, l = s ? r.scrollLeft() : 0, d = a.offset(),
        ...
        var n, a, s = e(this),
            ...
            c = "up" === l || "left" === l, u = t.distance || s["top" === d ? "outerHeight" : "outerWidth"](!0), h = {};
        e.effects.createPlaceholder(s), n = s.cssClip(), a = s.position()[d], h[d] = (c ? -1 : 1) * u + a, h.clip = s.cssClip(), h.clip[r[l][1]] = h.clip[r[l][0]], "show" === o && (s.cssClip(h.clip), s.css(d, h[d]), h.clip = n, h[d] = a), s.animate(h, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: i
            ...
            return n(e, [{
                ...
                key: "typewrite", value: function (e, t) {
                    ...
                    return !0 === this.pause.status ? void this.setPauseStatus(e, t, !0) : void (this.timeout = setTimeout((function () {
                        ...
                        if ("`" === r.charAt(0)) {
                            for (; "`" !== e.substr(t + a).charAt(0) && (a++, !(t + a > e.length));) ;
    ...
    e.each((function () {
        ...
        "open" != e.attr("data-state") ? e.find(".toggle-content").hide() : e.addClass("toggle-active").find(".toggle-content").slideDown(Number(t)), e.find(".toggle-header").off("click").on("click", (function () {
            return e.toggleClass("toggle-active").find(".toggle-content").slideToggle(Number(t)), !0
        }))
    }))
...
!function (jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        manageProgress: function () {
            ...
            return n.css({left: 0, width: d + "%"}), a.css({left: 0, width: l}), {totalTime: o, currentTime: r}
        },
        ...
        changeCoverImage: function (e) {
            ...
            if (t.opt.coverImage || t.orig_containment_background) {
                ...
                i && t.opt.containment.css({background: i, backgroundSize: "cover", backgroundAttachment: "fixed"})
            }
            return this
        },
...
-1 != (ix = jQuery.browser.fullVersion.indexOf(";")) && (jQuery.browser.fullVersion = jQuery.browser.fullVersion.substring(0, ix)), -1 != (ix = jQuery.browser.fullVersion.indexOf(" ")) && (jQuery.browser.fullVersion = jQuery.browser.fullVersion.substring(0, ix)), jQuery.browser.majorVersion = parseInt("" + jQuery.browser.fullVersion, 10), isNaN(jQuery.browser.majorVersion) && (jQuery.browser.fullVersion = "" + parseFloat(navigator.appVersion), jQuery.browser.majorVersion = parseInt(navigator.appVersion, 10)), jQuery.browser.version = jQuery.browser.majorVersion, jQuery.browser.android = /Android/i.test(nAgt), jQuery.browser.blackberry = /BlackBerry|BB|PlayBook/i.test(nAgt), jQuery.browser.ios = /iPhone|iPad|iPod|webOS/i.test(nAgt), jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt), jQuery.browser.windowsMobile = /IEMobile|Windows Phone/i.test(nAgt), jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt), jQuery.browser.mobile = jQuery.browser.android || jQuery.browser.blackberry || jQuery.browser.ios || jQuery.browser.windowsMobile || jQuery.browser.operaMobile || jQuery.browser.kindle, jQuery.isMobile = jQuery.browser.mobile, jQuery.isTablet = jQuery.browser.mobile && 765 < jQuery(window).width(), jQuery.isAndroidDefault = jQuery.browser.android && !/chrome/i.test(nAgt), jQuery.mbBrowser = jQuery.browser, jQuery.browser.versionCompare = function (e, t) {
    ...
    animate: function (e, t, i, n, a) {
        return this.each((function () {
            ...
            if (r.CSSAIsRunning && r.eventType == l.type && !jQuery.browser.msie && 9 >= jQuery.browser.version) r.CSSqueue = function () {
                ...
                if (e = jQuery.normalizeCss(e), r.CSSAIsRunning = !0, "function" == typeof t && (a = t, t = jQuery.fx.speeds._default), "function" == typeof i && (n = i, i = 0), "string" == typeof i && (a = i, i = 0), "function" == typeof n && (a = n, n = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof t) for (var d in jQuery.fx.speeds) {
                    if (t == d) {
                ...
                if (t || (t = jQuery.fx.speeds._default), "string" == typeof a && (n = a, a = null), jQuery.support.CSStransition) {
                    ...
                    c[n] && (n = c[n]), o.off(jQuery.CSS.transitionEnd + "." + r.id), c = jQuery.CSS.getProp(e);
                    var u = {};
        ...
        init: function (t) {
            return this.each((function () {
                ...
                var a = "h" == i.opt.orientation ? "horizontal" : "vertical",
                    s = e("<div/>").addClass("level").addClass(a);
                n.prepend(s), i.level = s, n.css({cursor: "default"}), "auto" == i.opt.maxval && (i.opt.maxval = e(i).outerWidth()), n.updateSliderVal(), i.opt.readonly || (n.on(e.simpleSlider.events.start, (function (t) {
...
}(jQuery), window.SEMICOLON_youtubeBgVideoInit = function (e) {
        ...
        s.prototype.THROTTLE_TIMEOUT = 100, s.prototype.POLL_INTERVAL = null, s.prototype.USE_MUTATION_OBSERVER = !0, s._setupCrossOriginUpdater = function () {
            ...
            if (this.root || !i || n) {
                ...
                this._observationTargets.forEach((function (n) {
                    var s = n.element, r = d(s), o = this._rootContainsTarget(s), l = n.entry,
                        c = e && o && this._computeTargetAndRootIntersection(s, r, t), u = n.entry = new a({
            ...
            if ("none" != window.getComputedStyle(t).display) {
                for (var r = a, o = p(t), c = !1; !c && o;) {
                    var h = null, f = 1 == o.nodeType ? window.getComputedStyle(o) : {};
                    if ("none" == f.display) return null;
                    if (o == this.root || 9 == o.nodeType) if (c = !0, o == this.root || o == e) i && !this.root ? !n || 0 == n.width && 0 == n.height ? (o = null, h = null, r = null) : h = n : h = s; else {
                        var m = p(o), g = m && d(m), v = m && this._computeTargetAndRootIntersection(m, g, s);
                        g && v ? (o = m, h = u(g, v)) : (o = null, r = null)
                    } else {
                        var y = o.ownerDocument;
                        o != y.body && o != y.documentElement && "visible" != f.overflow && (h = d(o))
                    }
                    if (h && (r = l(h, r)), !r) break;
                    o = o && p(o)
                }
                return r
            }
            ...
            var t;
            if (this.root) t = d(this.root); else {
    ...
    function l(e, t) {
        var i = Math.max(e.top, t.top), n = Math.min(e.bottom, t.bottom), a = Math.max(e.left, t.left),
            s = Math.min(e.right, t.right), r = s - a, o = n - i;
        return r >= 0 && o >= 0 && {top: i, bottom: n, left: a, right: s, width: r, height: o} || null
    }
    ...
    function p(t) {
        var i = t.parentNode;
        return 9 == t.nodeType && t != e ? f(t) : i && 11 == i.nodeType && i.host ? i.host : i && i.assignedSlot ? i.assignedSlot.parentNode : i
    }
